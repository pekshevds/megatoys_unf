...
Процедура ЗаполнитьПредставлениеРНПТ(
	...
	ИмяТабличнойЧастиПрослеживаемости = "СведенияПрослеживаемости") Экспорт 
	...
	Если СтрокаТабличнойЧасти.ПрослеживаемыйТовар И ПрослеживаемаяТЧ И Не ПоставщикРезидентТаможенногоСоюза Тогда
		Если Форма.ИмяФормы = "Обработка.ПомощникВводаНачальныхОстатков.Форма.ФормаВводаОстатков" Тогда
			...
			СтрокиСРНПТ = Форма.ВводНачальныхОстатковТовары[ИмяТабличнойЧастиПрослеживаемости].НайтиСтроки(Новый Структура("ИдентификаторСтроки", СтрокаТабличнойЧасти.ИдентификаторСтроки));
		Иначе
			Объект = Форма.Объект;
			СтрокаТабличнойЧасти.ПодсказкаРНПТ = "РНПТ:";
