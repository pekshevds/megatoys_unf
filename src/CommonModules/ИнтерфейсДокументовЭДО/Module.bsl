...
//  * АдресОписанияСообщения - Строка - адрес временного хранилища данных для просмотра.
...
Функция ПодготовитьДанныеПредварительногоПросмотра(ОписаниеОбъектаУчета, НастройкиФормирования, ПараметрыОткрытия) Экспорт
	...
	РезультатПодготовкиДанных.ИдентификаторОсновногоФайла = ?(ПозицияРасширения > 0, Лев(ИмяФайла, ПозицияРасширения - 1), ИмяФайла);
