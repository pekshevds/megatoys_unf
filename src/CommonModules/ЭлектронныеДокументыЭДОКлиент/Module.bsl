...
//   # Результат - см. РезультатЗавершенияВыполненияДействийПоЭДО
//                - Неопределено - в случае прерывания процесса, будет передано Неопределено
...
// Результат завершения выполнений действий по ЭДО
//
// Параметры:
//  КонтекстДействийПоЭДО - См. НовыйКонтекстДействийПоЭДО
//  
...
//
Функция РезультатЗавершенияВыполненияДействийПоЭДО(КонтекстДействийПоЭДО)
...
Процедура ЗавершитьВыполнениеДействийПоЭДО(КонтекстДействийПоЭДО, РезультатДействийПоЭДО = Неопределено)
	...
	Результат = РезультатЗавершенияВыполненияДействийПоЭДО(КонтекстДействийПоЭДО);
