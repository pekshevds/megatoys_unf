...
// Получить сопоставление реквизитов и свойств JSON.
// 
// Параметры:
...
Функция ПолучитьСопоставлениеРеквизитовИСвойствJSON(ТипДокумента) Экспорт
	...
	Если ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.УПД") Тогда
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Продавец.Наименование", "Продавец", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Покупатель.Наименование", "Покупатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Грузоотправитель.Наименование", "Грузоотправитель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Грузополучатель.Наименование.Наименование", "Грузополучатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Склад", "Склад", Метаданные.ОпределяемыеТипы.СкладБРД.Тип, , Истина);
		...
		// Таблица
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.ТоварНаименование", "Номенклатура", Метаданные.ОпределяемыеТипы.НоменклатураБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.СтавкаНДС", "СтавкаНДС", Метаданные.ОпределяемыеТипы.СтавкаНДСБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.Характеристика", "Характеристика", Метаданные.ОпределяемыеТипы.ХарактеристикаНоменклатурыБРД.Тип);		
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.ТОРГ12") Тогда
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "КонтейнерПоставщик.ПредставлениеПоставщика.Наименование", "Продавец", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "КонтейнерПлательщик.ПредставлениеПлательщика.Наименование", "Покупатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "КонтейнерИнформацияОбОрганизации.КонтейнерОрганизация.ПредставлениеОрганизации.Наименование", "Грузоотправитель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "КонтейнерГрузополучатель.ПредставлениеГрузополучателя.Наименование", "Грузополучатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Склад", "Склад", Метаданные.ОпределяемыеТипы.СкладБРД.Тип);
		...
		// Таблица
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.НаименованиеТовара", "Номенклатура", Метаданные.ОпределяемыеТипы.НоменклатураБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.СтавкаНДС", "СтавкаНДС", Метаданные.ОпределяемыеТипы.СтавкаНДСБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.Характеристика", "Характеристика", Метаданные.ОпределяемыеТипы.ХарактеристикаНоменклатурыБРД.Тип);
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.СчетФактура") Тогда
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Продавец_к.ПредставлениеПоставщика", "Продавец", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Покупатель_к.ПредставлениеПокупателя", "Покупатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Грузоотправитель_к.ПредставлениеГрузоотправителя", "Грузоотправитель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Грузополучатель_к.ПредставлениеГрузополучателя.Наименование", "Грузополучатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.АктОбОказанииУслуг") Тогда
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Исполнитель.Реквизиты.Наименование", "Продавец", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		//КонтейнерПлательщик.ПредставлениеПлательщика
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Заказчик.Реквизиты.Наименование", "Покупатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		
		//НетНаПечатнойФорме
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Грузоотправитель", "Грузоотправитель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип, Истина, Истина);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Грузополучатель", "Грузополучатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип, Истина, Истина);
		...
		//НетНаПечатнойФорме
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Склад", "Склад", Метаданные.ОпределяемыеТипы.СкладБРД.Тип, Истина, Истина);
		...
		// Таблица
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.Наименование", "Номенклатура", Метаданные.ОпределяемыеТипы.НоменклатураБРД.Тип);
		...
		//НетНаПечатнойФорме
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.СтавкаНДС", "СтавкаНДС", Метаданные.ОпределяемыеТипы.СтавкаНДСБРД.Тип, , Истина);
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.СчетНаОплату") Тогда
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "БанковскиеРеквизиты.Получатель.Наименование.НаименованиеОрганизации", "Продавец", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Заказчик.Реквизиты.Наименование", "Покупатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		...
		// Таблица
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.Товары", "Номенклатура", Метаданные.ОпределяемыеТипы.НоменклатураБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.Количество", "Количество", Новый ОписаниеТипов("Число", КвалификаторКоличество));
	...
	Иначе // Универсальный документ
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_2", "Продавец", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_3", "Покупатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_4", "Грузоотправитель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_5", "Грузополучатель", Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип);
		
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_6", "Договор", Новый ОписаниеТипов("СправочникСсылка.ДоговорыКонтрагентов"));
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_7", "Склад", Метаданные.ОпределяемыеТипы.СкладБРД.Тип, , Истина);
		...
		// Таблица
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_0", "Номенклатура", Метаданные.ОпределяемыеТипы.НоменклатураБРД.Тип);
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_01", "Характеристика", Метаданные.ОпределяемыеТипы.ХарактеристикаНоменклатурыБРД.Тип);
		...
		ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_5", "СтавкаНДС", Метаданные.ОпределяемыеТипы.СтавкаНДСБРД.Тип);
...
Функция НайтиПотенциальныеСвязанныеДокументы(Объект) Экспорт
	...
	Если Объект.ТипДокумента = Перечисления.ТипыДокументовРаспознаваниеДокументов.УПД
		...
		ТекстЗапроса = ПолучитьТекстЗапросаПоПервичнымДокументам(ИмяТипа);
		РаспознаваниеДокументовПереопределяемый.ТекстЗапросаПоПервичнымДокументам(ИмяТипа, ТекстЗапроса);
		...
		Иначе
			...
			ТекстЗапроса = ПолучитьТекстЗапросаПоПервичнымДокументам(ИмяТипа, Ложь);
			РаспознаваниеДокументовПереопределяемый.ТекстЗапросаПоПервичнымДокументам(ИмяТипа, ТекстЗапроса);
...
Функция ПолучитьТекстЗапросаПоПервичнымДокументам(ИмяТипа, ЕстьДокументОснование = Истина)
