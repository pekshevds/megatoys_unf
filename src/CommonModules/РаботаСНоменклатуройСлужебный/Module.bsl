...
Процедура ПолучитьДанныеДокументаАккредитации(ДанныеДокумента, ПараметрыДокумента) Экспорт
	...
	Если ЗапроситьВСервисе Тогда
		ПараметрыПовтора = ПараметрыПовтораЗапросовАккредитации();
		ПараметрыКоманды = Новый Структура("ДанныеДокумента, ПараметрыДокумента", ДанныеДокумента, ПараметрыДокумента);
		ВыполнитьДействиеВПовторе("ЗапросКСервисуАккредитацииВПовторе", ПараметрыКоманды, ПараметрыПовтора);
	КонецЕсли;
