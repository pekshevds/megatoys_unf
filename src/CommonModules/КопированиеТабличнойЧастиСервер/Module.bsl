...
Процедура Вставить(Объект, ИмяТЧ, ЭлементыФормы, КоличествоСкопированных, КоличествоВставленных) Экспорт
	...
	Если НоваяСтрока <> Неопределено Тогда
		ЭлементыФормы[ИмяЭлемента].ТекущаяСтрока = НоваяСтрока.ПолучитьИдентификатор();
	КонецЕсли;
...
// Осуществляет поиск строк таблицы значений, отвечающих заданному условию одного реквизита таблицы.
//
// Параметры:
//  ТЗ                 - ТаблицаЗначений - Таблица значений, в которой необходимо произвести отбор строк.
