...
Функция ПолучитьПроксиМенеджераСервиса()
	...
	Определение = Новый WSОпределения(Адрес, Логин, Пароль, , 20);
	Прокси = Новый WSПрокси(Определение, "http://www.1c.ru/1cFresh/PrivateAPI/1.0", "PrivateAPI", "PrivateAPISoap", , 20);
