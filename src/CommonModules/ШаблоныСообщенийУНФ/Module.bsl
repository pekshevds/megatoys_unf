...
//  ПредметСообщения - объект-родитель, у которого есть реквизиты, содержащие контактную информацию
//
...
// Параметры:
//  ДляПисем - Булево
//  Предмет  - объект, у которого есть реквизиты, содержащие контактную информацию
// 
