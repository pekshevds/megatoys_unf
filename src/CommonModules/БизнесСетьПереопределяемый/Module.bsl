...
//  ДанныеQRКодовПоДокументам - Список значений           - объекты печати (значение - ссылка на объект, представление -
//                                                          имя области, в которой был выведен объект).
//  ПечатнаяФорма             - ТабличныйДокумент         - печатная форма, в которой должна быть область
//                                                          "ДанныеQRКода", в которой должны быть параметры:
