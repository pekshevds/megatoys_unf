...
//
// Параметры:
//  Источник - ДокументСсылка.ЧекККМ - документ-источник.
//  Отказ - Булево
//
...
Функция ЗафиксироватьОшибкуСервисаЛояльности(ОписаниеОшибки, ИмяФункции) Экспорт
	...
	ЗаписьЖурналаРегистрации(НСтр("ru='Сервер лояльности.'") + ИмяФункции, УровеньЖурналаРегистрации.Ошибка, , , ОписаниеОшибки);
...
Процедура ОбработкаСостоянияБонусовИПодарочныхСертификатов() Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='СерверЛояльности.ОбработкаСостоянияБонусовИПодарочныхСертификатов'"), , , , ОписаниеОшибки);
	КонецПопытки;
...
//
Процедура СписокУправляемыхСкидок(СтруктураОтвета) Экспорт
	
	ТаблицаУправляемыхСкидок = ТаблицаУправляемыхСкидок();
	СерверЛояльностиПоставщикДанныхПереопределяемый.ЗаполнитьТаблицуУправляемыхСкидок(ТаблицаУправляемыхСкидок);
