...
Процедура ПодключитьСистемуБыстрыхПлатежей(
	...
	Если ПараметрыПодключения <> Неопределено Тогда
		ПараметрыПодключения.Свойство("БИК", БИК);
		ПараметрыПодключения.Свойство("ОтборУчастников", ОтборУчастников);
	КонецЕсли;
	
	НастройкиПодключения = Новый Структура;
	НастройкиПодключения.Вставить("БИК", БИК);
	...
	НастройкиПодключения.Вставить("ОтборУчастников", ОтборУчастников);
