...
Функция НовыйТелоЗапросаСодержимоеМонитора(
	...
	Если ПараметрыОбновления <> Неопределено Тогда
		...
		ЗаписьДанныхСообщения.ЗаписатьИмяСвойства("checkSupportStatus");
		ЗаписьДанныхСообщения.ЗаписатьЗначение(ПараметрыОбновления.ИнформироватьОВыходеВерсийДлительнойПоддержки);
