...
//
// Параметры:
//  ЗначениеИдентификатора - Строка - значение реквизита Идентификатор элемента справочника ПоказателиРасчетов
//
// Возвращаемое значение:
...
Функция ПараметрРасчетаСуществует(ЗначениеИдентификатора) Экспорт
	...
	Возврат НЕ Справочники.ПоказателиРасчетов.НайтиПоРеквизиту("Идентификатор", ЗначениеИдентификатора) = Справочники.ПоказателиРасчетов.ПустаяСсылка();
