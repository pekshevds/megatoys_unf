...
Процедура ЗаполнитьПрочиеДополнительныеРеквизитыТабличныхЧастей(Объект)
	...
	Если Не ОбработкаТабличныхЧастейПоКомиссии И Не ОбработкаТабличныхЧастейСкладскойУчет Тогда
		Возврат
	КонецЕсли;
	...
	Если ОбработкаТабличныхЧастейСкладскойУчет И ЭтоЗаказНаряд Тогда
