...
//  ФормаВладелец   - ФормаКлиентскогоПриложения, Неопределено - форма, которая будет являться владельцем формы
//                                                               протокола обмена.
//
...
Процедура ПодтвердитьПоступление_ПослеПолученияДокументовКПодтверждению(ДокументыКПодтверждению, ДополнительныеПараметры) Экспорт
	...
	ПодготовитьСообщенияКПередачеДляДокументовИзСписка(
...
Процедура НачатьВыполнениеОбмена()
	...
	СообщенияПоОрганизациям = СообщенияПоОрганизациям(Результат.СообщенияXML);
