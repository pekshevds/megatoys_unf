...
Функция НайтиДокументыПоКонтакту(Контакт)
	...
	Если ДанныеКонтрагента.Покупатель = Истина Тогда
		Заказы = ЗаказыПокупателейПоКонтакту(Контакт);
	ИначеЕсли ДанныеКонтрагента.Поставщик = Истина Тогда
...
Функция ДополнитьТаблицуСтрокамиПоОтбору(ТаблицаИсточник, ТаблицаПриемник, Отбор)
...
Процедура ДополнитьТаблицуУникальнымиСтроками(ТаблицаИсточник, ТаблицаПриемник, КолонкаСравнение)
