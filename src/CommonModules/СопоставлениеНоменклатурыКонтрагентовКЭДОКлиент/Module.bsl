...
//  ПредставлениеНоменклатурыКонтрагента - Строка                      - имя поля, которое необходимо отображать при
//                                                                       открытие формы.
//  ОповещениеОЗакрытие                  - ОписаниеОповещения          - оповещения, которое необходимо выполнить после
//                                                                       закрытия формы.
//
