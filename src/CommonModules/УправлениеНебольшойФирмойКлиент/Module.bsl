...
Процедура ПредложитьВозможностьНажатие(Тег, Текст = "") Экспорт
	...
	Получатель.Добавить("sbm@1c.ru", НСтр("ru ='Команда разработки приложения'"));
...
// Процедура обработчик завершения загрузки файла в веб клиенте
//
// Параметры:
//  Результат				 - Структура	 - Результат загрузки
//  ДополнительныеПараметры	 - Структура	 - Дополнительные параметры загрузки
//
Процедура ЗагрузитьНаВебКлиентеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	
	Если Результат <> Неопределено Тогда
		
		АдресВременногоХранилища = Результат.Адрес;
...
Процедура ЗагрузитьДанныеИзФайлаВыпискиЗавершение(Успешно, Адрес, ВыбранноеИмяФайла, ДополнительныеПараметры) Экспорт
	...
	ЗагрузитьНаВебКлиентеЗавершение(Результат, ДополнительныеПараметры);
...
Процедура ЗагрузитьДанныеИзФайлаВыпискиФрагмент(ДополнительныеПараметры)
	...
	ПараметрыОткрытия.Вставить("ФайлЗагрузки", ДополнительныеПараметры.ПутьДоФайла1);
...
Процедура ЗаполнитьТелефонАдресЭП(ЭтаФорма, ТелефонАдресЭП, НеПечататьБумажныйЧек = Ложь) Экспорт
	...
	ИначеЕсли Не НеПечататьБумажныйЧек Тогда
