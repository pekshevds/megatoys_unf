...
Функция ПараметрыШтрихкодаGS1(Знач Штрихкод, ПараметрыШтрихкода = Неопределено) Экспорт
	...
	Иначе
		...
		Если ТекущийИдентификаторПримененияНайден Тогда
			...
			// Если параметр переменной длины, то последим символом будет либо последний символ определенной длины (если
			// ДлинаЗначения <> 0), либо символ окончания параметра переменной длины (один из заданных в массиве СимволыОкончанияСтрокиПеременнойДлины).
