...
Функция ДанныеЗаполненияДокументовПоИностраннымГражданам(ВидУведомления, Основание) Экспорт
	...
	КадровыеДанныеСотрудника = КадровыеДанныеСотрудника(ДанныеДокумента.Сотрудник,
		"Фамилия,Имя,Отчество,ДатаРождения,Страна,МестоРождения,Пол,"
		+ "ДокументВид,ДокументСерия,ДокументНомер,ДокументДатаВыдачи,ДокументКемВыдан,"
		+ "ДатаДоговораКонтракта,Страна,ПриказОПриеме, Должность", ДанныеДокумента.ДатаСведений);
