...
Функция ПолучитьЗначениеПараметра(Объект, Документ = Неопределено, Параметр, ПараметрПредставление = Неопределено) Экспорт
	...
	ИначеЕсли Параметр = Параметры.РуководительОрганизацииИнициалы Тогда
		...
		ФамилияИнициалы = РегистрыСведений.ФИОФизическихЛиц.ФИОФизЛица(, РуководительОрганизации);
...
Функция ПолучитьЗначениеДополнительногоРеквизита(Объект, Документ, РеквизитСсылка) Экспорт
	...
	Если РеквизитСсылка.НаборСвойств = УправлениеСвойствами.НаборСвойствПоИмени("Справочник_ДоговорыКонтрагентов") Тогда
		ЗначенияДополнительныхРеквизитов = Объект.ДополнительныеРеквизиты;
	ИначеЕсли РеквизитСсылка.НаборСвойств = УправлениеСвойствами.НаборСвойствПоИмени("Справочник_Контрагенты") Тогда
		ЗначенияДополнительныхРеквизитов = Объект.Владелец.ДополнительныеРеквизиты;
	ИначеЕсли РеквизитСсылка.НаборСвойств = УправлениеСвойствами.НаборСвойствПоИмени("Документ_ЗаказПокупателя") Тогда
		Если Документ <> Неопределено Тогда
			ЗначенияДополнительныхРеквизитов = Документ.ДополнительныеРеквизиты;
		Иначе
			ЗначенияДополнительныхРеквизитов = Неопределено;
		КонецЕсли;
	ИначеЕсли РеквизитСсылка.НаборСвойств = УправлениеСвойствами.НаборСвойствПоИмени("Документ_СчетНаОплату") Тогда
		Если Документ <> Неопределено Тогда
			ЗначенияДополнительныхРеквизитов = Документ.ДополнительныеРеквизиты;
		Иначе
			ЗначенияДополнительныхРеквизитов = Неопределено;
		КонецЕсли;
	ИначеЕсли РеквизитСсылка.НаборСвойств = УправлениеСвойствами.НаборСвойствПоИмени("Справочник_Организации") Тогда
