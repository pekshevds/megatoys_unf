...
// 	CommonModule.ТелефонияItoolabs, CommonModule.ТелефонияMangoOffice, CommonModule.ТелефонияРостелеком, CommonModule.ТелефонияБилайн - Описание
Функция ПриОпределенииМодуляИнтеграции(АТС) Экспорт
	...
	МодулиИнтеграции.Вставить(Перечисления.ДоступныеАТС.Билайн, ТелефонияБилайн);
