...
//       ** ПереводыСБПc2b - Булево - признак доступности переводов СБП c2b;
...
Функция НастройкиПодключения(Настройка) Экспорт
	...
	Если НастройкиУчастникаСБП <> Неопределено Тогда
		...
		НастройкиСБПc2b.Вставить("ПодключениеКассовойСсылки",
			(НастройкиУчастникаСБП.ПодключениеКассовойСсылки
			Или ОбщиеНастройки.Идентификатор <> "PayMaster"));
