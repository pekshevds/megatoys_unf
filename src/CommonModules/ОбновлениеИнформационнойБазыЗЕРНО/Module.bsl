...
#Область Отложенно
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "10.1.27.1";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "Константы.НастройкиОбменаЗЕРНО.ОбработатьДанныеДляПереходаНаНовуюВерсиюAPI_1_0_5";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("5dd2a43e-0ab7-11ee-a411-4cedfb43b158");
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Константы.НастройкиОбменаЗЕРНО.ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсиюAPI_1_0_5";
	...
	Обработчик.Комментарий = НСтр("ru = 'Изменяет версию API ФГИС ""Зерно"" на 1.0.5, если установлена версия 1.0.3'");
