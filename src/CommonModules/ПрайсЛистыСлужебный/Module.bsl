...
Функция ИнициализироватьНастройкиОтбораПрайсЛиста(УникальныйИдентификатор) Экспорт
	...
	ЗаполнитьПоляНабораСхемыКомпоновкиДанныхПоУмолчанию(НаборДанных.Поля);

	НаборДанных.Запрос = "ВЫБРАТЬ
	|	Справочник.Номенклатура.Ссылка КАК Номенклатура,
	|	Справочник.ХарактеристикиНоменклатуры.Ссылка КАК Характеристика,
	|	Справочник.Организации.Ссылка КАК ОстаткиОрганизации,
	|	Справочник.СтруктурныеЕдиницы.Ссылка КАК ОстаткиСклада"; 
...
Процедура ЗаполнитьПоляНабораСхемыКомпоновкиДанныхПоУмолчанию(ПоляНабораДанных)
	
	ТипПолеНабораДанныхСхемыКомпоновкиДанных = Тип("ПолеНабораДанныхСхемыКомпоновкиДанных");
	
	ПолеНабораДанныхСхемыКомпоновкиДанных = ПоляНабораДанных.Добавить(ТипПолеНабораДанныхСхемыКомпоновкиДанных);
	ПолеНабораДанныхСхемыКомпоновкиДанных.Поле 			= "Номенклатура";
	ПолеНабораДанныхСхемыКомпоновкиДанных.ПутьКДанным 	= "Номенклатура";
	ПолеНабораДанныхСхемыКомпоновкиДанных.Заголовок 	= НСтр("ru = 'Номенклатура'");    
	
	ПолеНабораДанныхСхемыКомпоновкиДанных = ПоляНабораДанных.Добавить(ТипПолеНабораДанныхСхемыКомпоновкиДанных);
	ПолеНабораДанныхСхемыКомпоновкиДанных.Поле 			= "Характеристика";
	ПолеНабораДанныхСхемыКомпоновкиДанных.ПутьКДанным 	= "Характеристика";
	ПолеНабораДанныхСхемыКомпоновкиДанных.Заголовок 	= НСтр("ru = 'Характеристика'");

	ПолеНабораДанныхСхемыКомпоновкиДанных = ПоляНабораДанных.Добавить(ТипПолеНабораДанныхСхемыКомпоновкиДанных);
	ПолеНабораДанныхСхемыКомпоновкиДанных.Поле 			= "ОстаткиОрганизации";
	ПолеНабораДанныхСхемыКомпоновкиДанных.ПутьКДанным 	= "ОстаткиОрганизации";
	ПолеНабораДанныхСхемыКомпоновкиДанных.Заголовок 	= НСтр("ru = 'Организация остатков'");

	ПолеНабораДанныхСхемыКомпоновкиДанных = ПоляНабораДанных.Добавить(ТипПолеНабораДанныхСхемыКомпоновкиДанных);
	ПолеНабораДанныхСхемыКомпоновкиДанных.Поле 			= "ОстаткиСклада";
	ПолеНабораДанныхСхемыКомпоновкиДанных.ПутьКДанным 	= "ОстаткиСклада";
	ПолеНабораДанныхСхемыКомпоновкиДанных.Заголовок 	= НСтр("ru = 'Склад остатков'") ;
...
Функция АссортиментПрайсЛистаОрганизацииСИерархией(ПрайсЛистОрганизацииСсылка, ИспользоватьХарактеристики = Ложь) Экспорт
	...
	Для каждого СтрокаТаблицы Из ПрайсЛистОрганизацииСсылка.ВидыЦен Цикл
		...
		ПараметрыФормирования.ВидыЦен.Добавить(
			Новый Структура("ВидЦен, Использование", СтрокаТаблицы.ВидЦен, СтрокаТаблицы.Использование));
		
	КонецЦикла;
	
	ПараметрыФормирования.Вставить("ПредставлениеНоменклатуры", Новый Массив);
	
	Для каждого СтрокаПредставленияНоменклатуры Из ПрайсЛистОрганизацииСсылка.ПредставлениеНоменклатуры Цикл
		...
		ПараметрыФормирования.ПредставлениеНоменклатуры.Добавить(ОписаниеСтроки);
