...
Функция ВыполнитьКонтрольСопоставленияНоменклатуры(Знач ДанныеЭлектронногоДокумента = Неопределено,
	...
	НеСопоставлено = НеСопоставленнаяНоменклатураКонтрагента(НаСопоставление, 
	...
	Для Каждого СтрокаПараметров Из ДанныеДокументов Цикл
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(ШаблонСообщения,
				СтрокаПараметров.ПредставлениеДокумента, ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке()));
