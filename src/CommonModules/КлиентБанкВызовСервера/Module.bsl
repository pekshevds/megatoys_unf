...
// например, для новой организации, то обязательно проверить подключено ли 
...
Функция ПолучитьСтруктуруПрямогоОбмена() Экспорт
	...
	СтруктураПрямогоОбмена.Вставить("КонтролироватьБезопасностьОбменаСБанком", Истина);
	СтруктураПрямогоОбмена.Вставить("РежимПоУмолчанию", "ГруппаЗагрузка");
...
Функция ПолучитьСтруктуруОбмена(ПараметрБанковскийСчет) Экспорт
	...
	СтруктураОбмена.Вставить("РежимПоУмолчанию", "ГруппаЗагрузка");
