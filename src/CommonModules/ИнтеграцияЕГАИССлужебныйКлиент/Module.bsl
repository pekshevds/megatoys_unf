...
//
// Параметры:
//  ОповещениеПриЗавершении            - ОписаниеОповещения - процедура которую надо выполнить после передачи всех
//                                                            данных в УТМ
...
// Только для внутреннего использования.
//
// Запускает очередь обмена с УТМ ЕГАИС (через глобальную переменную ПараметрыПриложения["ЕГАИС.ДанныеСеансаОбмена"]),
// передача данных
...
//
// Запускает очередь обмена с УТМ ЕГАИС (через глобальную переменную ПараметрыПриложения["ЕГАИС.ДанныеСеансаОбмена"]),
// получение списков входящих документов
...
//
// Запускает очередь обмена с УТМ ЕГАИС (через глобальную переменную ПараметрыПриложения["ЕГАИС.ДанныеСеансаОбмена"]),
// удаление полученных документов
