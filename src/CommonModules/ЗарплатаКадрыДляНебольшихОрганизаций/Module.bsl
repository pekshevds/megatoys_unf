...
Процедура ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек) Экспорт
	...
	КадровыйЭДО.ДобавитьНастройкуПечатнойФормы(
		ОписанияНастроек,
		Метаданные.ОбщиеМакеты.ПФ_MXL_Т8.Имя,
		Перечисления.СодержимоеДокументов.НеСодержитЗарплаты);
	
	КадровыйЭДО.ДобавитьНастройкуПечатнойФормы(
		ОписанияНастроек,
		Метаданные.ОбщиеМакеты.ПФ_MXL_Т6.Имя,
		Перечисления.СодержимоеДокументов.НеСодержитЗарплаты);
	
	КадровыйЭДО.ДобавитьНастройкуПечатнойФормы(
		ОписанияНастроек,
		Метаданные.Документы.ДоговорРаботыУслуги.Макеты.ПФ_MXL_ДоговорПодряда.Имя,
		Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки);
	
	КадровыйЭДО.ДобавитьНастройкуПечатнойФормы(
		ОписанияНастроек,
		Метаданные.Документы.ДоговорРаботыУслуги.Макеты.ПФ_MXL_АктСдачиПриемкиВыполненныхРаботУслуг.Имя,
