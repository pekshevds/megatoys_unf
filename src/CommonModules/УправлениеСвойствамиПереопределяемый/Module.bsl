...
Процедура ЗаполнитьНаборыСвойствОбъекта(Знач Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	УправлениеСвойствамиУНФ.ЗаполнитьНаборыСвойствОбъекта(Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка,
		КлючНазначения);
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	УправлениеСвойствамиУНФ.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
...
// См. УправлениеСвойствамиУНФ.ЗаполнитьДополнительныеПараметры
Функция ЗаполнитьДополнительныеПараметры(Объект = Неопределено, ИмяЭлементаДляРазмещения = Неопределено,
	ПроизвольныйОбъект = Неопределено, ИмяЭлементаКоманднойПанели = Неопределено, СкрытьУдаленные = Неопределено) Экспорт

	Возврат УправлениеСвойствамиУНФ.ЗаполнитьДополнительныеПараметры(Объект, ИмяЭлементаДляРазмещения,
		ПроизвольныйОбъект, ИмяЭлементаКоманднойПанели, СкрытьУдаленные);

КонецФункции

// Устарела. Будет удалена в следующей версии программы.
// См. УправлениеСвойствамиУНФ.ТаблицаСвойствПриСозданииНаСервере
Процедура ТаблицаСвойствПриСозданииНаСервере(Форма, Объект = Неопределено, ВладелецСвойств = Неопределено,
	...
	УправлениеСвойствамиУНФ.ТаблицаСвойствПриСозданииНаСервере(Форма, Объект, ВладелецСвойств,
		ЗаполнитьОписаниеЗависимостей);

КонецПроцедуры

// Устарела. Будет удалена в следующей версии программы.
// См. УправлениеСвойствамиУНФ.ТаблицаСвойствОбработкаПроверкиЗаполненияНаСервере
Процедура ТаблицаСвойствОбработкаПроверкиЗаполненияНаСервере(Форма, Объект = Неопределено, Отказ) Экспорт

	УправлениеСвойствамиУНФ.ТаблицаСвойствОбработкаПроверкиЗаполненияНаСервере(Форма, Объект, Отказ);

КонецПроцедуры

// Устарела. Будет удалена в следующей версии программы.
// См. УправлениеСвойствамиУНФ.ТаблицаСвойствПередЗаписьюНаСервере
Процедура ТаблицаСвойствПередЗаписьюНаСервере(Форма, Объект) Экспорт

	УправлениеСвойствамиУНФ.ТаблицаСвойствПередЗаписьюНаСервере(Форма, Объект);

КонецПроцедуры

// Устарела. Будет удалена в следующей версии программы.
// См. УправлениеСвойствамиУНФ.ЗаполнитьДополнительныеРеквизитыВФорме
Процедура ЗаполнитьДополнительныеРеквизитыВФорме(Форма, Объект = Неопределено, ВладелецСвойств = Неопределено,
	ЗаполнитьОписаниеЗависимостей = Истина) Экспорт

	УправлениеСвойствамиУНФ.ЗаполнитьДополнительныеРеквизитыВФорме(Форма, Объект, ВладелецСвойств,
		ЗаполнитьОписаниеЗависимостей);
