...
Функция ДанныеСертификатовОрганизаций(Организации) Экспорт
	...
	Если ЗначениеЗаполнено(СертификатыОрганизаций) Тогда
		...
		Для Каждого СертификатыОрганизации Из СертификатыОрганизаций Цикл
			Если ЗначениеЗаполнено(СертификатыОрганизации.Значение)
				И ТипЗнч(СертификатыОрганизации.Значение[0]) = Тип("СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования") Тогда
				
				ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ВсеСертификаты, СертификатыОрганизации.Значение);
			КонецЕсли;
		КонецЦикла;
		Если ЗначениеЗаполнено(ВсеСертификаты) Тогда
			...
			Для Каждого СертификатыОрганизации Из СертификатыОрганизаций Цикл
				Для Каждого СертификатОрганизации Из СертификатыОрганизации.Значение Цикл
					Если ДействующиеСертификаты.Найти(СертификатОрганизации) = Неопределено Тогда
		...
		Пока Выборка.СледующийПоЗначениюПоля("Организация") Цикл
			...
			Если ЗначениеЗаполнено(Выборка.Сертификат) Тогда
				...
				Если ТипЗнч(СертификатыПоУмолчанию) = Тип("Соответствие") Тогда
					СертификатыПоУмолчанию = ОбщегоНазначения.ВыгрузитьКолонку("Ключ");
				КонецЕсли;
		...
		Для Каждого ФайлДляВывода Из ПрисоединенныеФайлы Цикл
			...
			Если ДанныеФайла.ПодписанЭП Тогда
				...
				Для Каждого ОписаниеПодписи Из ПодписиФайла Цикл
					...
					Если ЗначениеЗаполнено(ОписаниеПодписи.ИмяФайла) Тогда
						ИмяФайлаПодписи = ОписаниеПодписи.ИмяФайла;
					Иначе
