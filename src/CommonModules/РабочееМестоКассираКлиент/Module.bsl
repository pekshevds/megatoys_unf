...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Если ПараметрыРаботыКлиента.Свойство("ЕстьПрофильРМК") И ПараметрыРаботыКлиента.ЕстьПрофильРМК Тогда
		Если ПараметрыРаботыКлиента.Свойство("ЗапуститьНовыйРМК") И Не ПараметрыРаботыКлиента.ЗапуститьНовыйРМК Тогда
...
Процедура ПредпросмотрЧекаДенежныхДокументов(Параметры, Владелец, ИдентификаторУстройства) Экспорт
	...
	Если ИдентификаторУстройства <> Неопределено Тогда
		...
		Параметры = ОборудованиеЧекопечатающиеУстройстваВызовСервера.СформироватьШаблонЧека(Параметры, Неопределено, Неопределено, ИдентификаторУстройства);
	...
	Разделитель = "------------------------------------------------";
	КУдалению = "================================================";
	ТекстЧека = ОборудованиеЧекопечатающиеУстройстваКлиентСервер.СформироватьТекстНефискальногоЧека(Параметры, 48);
