...
Функция ПереформироватьДокумент(Параметры, КонтекстДиагностики) Экспорт
	...
	Попытка
		...
		Если Параметры.ТребуетсяФормированиеДокумента = Истина Тогда
			...
			Результат.РезультатДействийПоЭДО = ЭлектронныеДокументыЭДО.ВыполнитьДействияПоЭДО(
		...
		Результат.РезультатДействийПоЭДО = ЭлектронныеДокументыЭДО.ВыполнитьДействияПоЭДО(ПараметрыДействийПоЭДО, 
			КонтекстДиагностики);
