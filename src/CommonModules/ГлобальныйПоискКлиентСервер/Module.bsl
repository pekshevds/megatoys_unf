...
#Иначе
	ЦветТекстаПодсказки = ОбщегоНазначенияКлиент.ЦветСтиля("ЦветВторостепеннаяСтрокаГлобальногоПоиска");
#КонецЕсли
...
#Иначе
	ЦветТекстаПодсказки = ОбщегоНазначенияКлиент.ЦветСтиля("ЦветВторостепеннаяСтрокаГлобальногоПоиска");
	ЦветТекстаВыделения = ОбщегоНазначенияКлиент.ЦветСтиля("ЦветСовпавшейПодстрокиГлобальногоПоиска");
#КонецЕсли
