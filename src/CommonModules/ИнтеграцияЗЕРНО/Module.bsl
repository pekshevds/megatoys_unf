...
//  ИдентификаторПроблемы Идентификатор проблемы
...
Функция РегЗаданияНастроены(РезультатЗапроса, ИдентификаторПроблемы, ВсеЗадания = Истина) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ЗначениеЗаполнено(Выборка.РегламентноеЗадание) Тогда 
			Если ВсеЗадания И Включено = Истина Тогда
				Включено = Ложь;
			КонецЕсли;
			Продолжить;
		КонецЕсли;
		...
		Включено = (ТекВключено Или Включено = Истина И Не ВсеЗадания)
			Или (ТекВключено И ВсеЗадания И Включено = Истина);
	КонецЦикла;
...
Функция СостояниеОбмена(Организации) Экспорт
	...
	Запрос.УстановитьПараметр("СертификатыОрганизаций", СертификатыОрганизаций());
...
Функция СертификатыОрганизаций()
	...
	НастройкиОбменаГосИС = ИнтеграцияИС.НастройкиОбменаГосИС();
