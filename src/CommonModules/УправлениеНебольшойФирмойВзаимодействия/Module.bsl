...
Процедура ДобавитьВложенияКартинкиВПисьмо(ТекстHTML, ВложенияПисьма, знач ВложенияКартинки) Экспорт
	...
	Для Каждого Картинка Из ДокументHTML.Картинки Цикл
		...
		ИдентификаторКартинки = СоответствиеИмениКартинкиИдентификатору.Получить(АтрибутИсточникКартинки.ТекстовоеСодержимое);
		Если ИдентификаторКартинки = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		
		НовыйАтрибутКартинки = АтрибутИсточникКартинки.КлонироватьУзел(Ложь);
		НовыйАтрибутКартинки.ТекстовоеСодержимое = СтрШаблон("cid:%1", ИдентификаторКартинки);
