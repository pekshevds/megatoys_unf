...
Процедура РасчетПоказателей_РСВ_2023(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц, ВыделятьМеждународныеДоговоры = Ложь) Экспорт
