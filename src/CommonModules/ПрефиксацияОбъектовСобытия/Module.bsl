...
Процедура УстановитьПрефикс(Источник, Префикс, УстановитьПрефиксИнформационнойБазы, УстановитьПрефиксОрганизации)
	...
	//+mega
	//Если ТипЗнч(Источник) = Тип("ДокументОбъект.РасходнаяНакладная") ИЛИ 
	//	ТипЗнч(Источник) = Тип("ДокументОбъект.КорректировкаРеализации")ИЛИ 
	//	ТипЗнч(Источник) = Тип("ДокументОбъект.ПередачаТоваровМеждуОрганизациями")
	//	И Источник.Дата > '20200101000000' Тогда
	//	
	//	ПрефиксИнформационнойБазы = Формат(Источник.Дата, "ДФ=MM");
	//	Префикс = Формат(Источник.Дата, "ДФ=dd");		
	//КонецЕсли;
	//-mega
