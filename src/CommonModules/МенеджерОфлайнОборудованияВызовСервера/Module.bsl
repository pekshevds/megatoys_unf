...
Функция ПодключаемоеОборудованиеЭвоторОФД(ИдентификаторУстройства) Экспорт
	...
	Если ИдентификаторУстройства.ОбработчикОфлайнОборудования = Перечисления.ОбработчикиОфлайнОборудования.Обработчик1СЭвоторККМОфлайн 
		ИЛИ ИдентификаторУстройства.ОбработчикОфлайнОборудования = Перечисления.ОбработчикиОфлайнОборудования.ОбработчикОФД Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
