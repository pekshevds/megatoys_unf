...
Процедура ПоказатьВопросСозданияНастройкиПодключенияЗавершение(
	...
	Если Ответ = КодВозвратаДиалога.Да Тогда
		...
		ПараметрыПодключения.Вставить("БИК", Параметры.ДополнительныеНастройки.БИК);
		ПараметрыПодключения.Вставить("ОтборУчастников", Параметры.ДополнительныеНастройки.ОтборУчастников);
