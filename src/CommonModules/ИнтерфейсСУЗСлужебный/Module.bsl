...
Функция ШаблонКодаМаркировки(Знач ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПиво Тогда
		Результат = 28;
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.СоковаяПродукция Тогда
		Результат = 29;
...
Функция ТипКодаМаркировки(Знач ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Духи
		...
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.АнтисептикиСтандартныйКМ
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БАДы
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БАДыСтандартныйКМ
		...
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.СоковаяПродукция
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БезалкогольноеПиво
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.ТабачнаяПачка
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.ПродукцияИзНатуральногоМеха
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.КреслаКоляски Тогда
		Результат = "UNIT";
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.ДухиНабор
		...
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.АнтисептикиНаборСтандартныйКМ
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БАДыНабор
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.БАДыНаборСтандартныйКМ
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.МолочнаяПродукцияПодконтрольнаяВЕТИСНабор
