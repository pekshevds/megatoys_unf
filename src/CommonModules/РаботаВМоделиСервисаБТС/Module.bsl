...
Процедура ПриОшибкеПодготовкиОбластиИзВыгрузки(ПараметрыЗадания, ИнформацияОбОшибке) Экспорт
	...
	Если Не МенеджерОбластиДанных.Выбран() Тогда
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Область данных %1 не найдена'"), ОбластьДанных);
	КонецЕсли;
	...
	Попытка
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Область данных.Ошибка при загрузке из файла'", ОбщегоНазначения.КодОсновногоЯзыка()),
