...
Функция ПолучитьОстаткиОплаты(ДокументОбъект, ЭтоЗаказ, ПараметрыЗаполненияЗаголовка) Экспорт
	...
	СтруктураДляВозврата = Новый Структура;
	СтруктураДляВозврата.Вставить("Оплачено", 0);
	СтруктураДляВозврата.Вставить("ВТомЧислеАвто", 0);
	СтруктураДляВозврата.Вставить("НеРаспределено", 0);
	СтруктураДляВозврата.Вставить("НеРаспределеноВал", 0);
	СтруктураДляВозврата.Вставить("ВалютаОстатков", Неопределено);
