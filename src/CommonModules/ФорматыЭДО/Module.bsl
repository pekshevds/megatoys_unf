...
Функция ЗаполнитьДанныеДоверенностейДокумента(ОписаниеФайла, Организация, Доверенности, СодержаниеДокумента) Экспорт
	...
	Если ДанныеФайлаЭД.Свойства().Получить("ИдФайл") <> Неопределено Тогда
		...
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "ON_NSCHFDOPPOK") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_УПД2019_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
			
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_TOVTORGPR") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_ПередачаТоваров_ИнформацияПродавца(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_TOVTORGPOK") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_ПередачаТоваров_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
			
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_REZRUISP") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_ПередачаРабот_ИнформацияИсполнителя(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_REZRUZAK") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_ПередачаРабот_ИнформацияЗаказчика(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
			
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "ON_NKORSCHFDOPPR") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_УКД2020_ИнформацияПродавца(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "ON_NKORSCHFDOPPOK") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_УКД2020_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
			
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_PRIRASXPRIN") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_АктОРасхождениях_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_PRIRASXDOP") > 0 Тогда
			ЗаполнитьДанныеДоверенностейЭД_АктОРасхождениях_ДопСведения(ДанныеФайлаЭД, Доверенности, ПространствоИмен);
			
		ИначеЕсли СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_IZVPOL") > 0 Или СтрНайти(ДанныеФайлаЭД.ИдФайл, "DP_UVUTOCH") > 0 Тогда
	...
	Если Не ЗначениеЗаполнено(ОписаниеОшибки) Тогда
		...
		Попытка
			...
			ИначеЕсли URIПространстваИмен = "ON_AKTSVEROTP_1_972_01_05_01_01"
				...
				Или URIПространстваИмен = Обработки.ФорматДоговорнойДокумент101.ПространствоИмен()
...
// Заполняет данные МЧД подписанта в файле электронного документа информации продавца УПД2019.
// 
// Параметры:
...
Процедура ЗаполнитьДанныеДоверенностейЭД_УПД2019_ИнформацияПродавца(ДанныеФайлаЭД, Доверенности, ПространствоИмен) 
	...
	Если ДанныеФайлаЭД.Документ.Функция = "СЧФДОП"
		Или ДанныеФайлаЭД.Документ.Функция = "ДОП" Тогда
		ИнфПолФХЖ1 = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СвСчФакт.ИнфПолФХЖ1",
			ПолучитьОбъектТипаCML("Файл.Документ.СвСчФакт.ИнфПолФХЖ1", ПространствоИмен));
		ДанныеФайлаЭД.Документ.СвСчФакт.ИнфПолФХЖ1 = ИнфПолФХЖ1;
		ИнфПоляДляЗаполнения.Добавить(ИнфПолФХЖ1);
		
		ИнфПолФХЖ3 = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СвПродПер.ИнфПолФХЖ3",
			ПолучитьОбъектТипаCML("Файл.Документ.СвПродПер.ИнфПолФХЖ3", ПространствоИмен));
	...
	Для Каждого ИнфПолФХЖ Из ИнфПоляДляЗаполнения Цикл
		ЗаполнитьДанныеДоверенностейВИнформационныхПоляхЭД(Доверенности, ИнфПолФХЖ, ПространствоИмен);
	КонецЦикла;
...
Процедура ЗаполнитьДанныеДоверенностейЭД_УПД2019_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен)

	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "ИнфПок.СодФХЖ4.ИнфПолФХЖ4",
		ПолучитьОбъектТипаCML("Файл.ИнфПок.СодФХЖ4.ИнфПолФХЖ4", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_ПередачаТоваров_ИнформацияПродавца(ДанныеФайлаЭД, Доверенности, ПространствоИмен)

	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, 
		"Документ.СвДокПТПрКроме.СвДокПТПр.СодФХЖ1.ИнфПолФХЖ1",
		ПолучитьОбъектТипаCML("Файл.Документ.СвДокПТПрКроме.СвДокПТПр.СодФХЖ1.ИнфПолФХЖ1", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_ПередачаТоваров_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен)

	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СодФХЖ4.ИнфПолФХЖ4",
		ПолучитьОбъектТипаCML("Файл.Документ.СодФХЖ4.ИнфПолФХЖ4", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_ПередачаРабот_ИнформацияИсполнителя(ДанныеФайлаЭД, Доверенности, ПространствоИмен)

	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СвДокПРУ.СодФХЖ1.ИнфПолФХЖ1",
		ПолучитьОбъектТипаCML("Файл.Документ.СвДокПРУ.СодФХЖ1.ИнфПолФХЖ1", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_ПередачаРабот_ИнформацияЗаказчика(ДанныеФайлаЭД, Доверенности, ПространствоИмен)

	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СодФХЖ3.ИнфПолФХЖ3",
		ПолучитьОбъектТипаCML("Файл.Документ.СодФХЖ3.ИнфПолФХЖ3", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_УКД2020_ИнформацияПродавца(ДанныеФайлаЭД, Доверенности, ПространствоИмен)

	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СвКСчФ.ИнфПолФХЖ1",
		ПолучитьОбъектТипаCML("Файл.Документ.СвКСчФ.ИнфПолФХЖ1", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_УКД2020_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен)
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_АктОРасхождениях_ИнформацияПокупателя(ДанныеФайлаЭД, Доверенности, ПространствоИмен)
	
	ИнфПолФХЖ = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СодФХЖ1.ИнфПолФХЖ1",
		ПолучитьОбъектТипаCML("Файл.Документ.СодФХЖ1.ИнфПолФХЖ1", ПространствоИмен));
...
//  Доверенности - Массив Из ОпределяемыйТип.МашиночитаемаяДоверенность
//  ПространствоИмен - Строка - Пространство имен схемы документа.
Процедура ЗаполнитьДанныеДоверенностейЭД_АктОРасхождениях_ДопСведения(ДанныеФайлаЭД, Доверенности, ПространствоИмен)
	
	ИнфПол = РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(ДанныеФайлаЭД, "Документ.СвИтПрием.ИнфПол",
		ПолучитьОбъектТипаCML("Файл.Документ.СвИтПрием.ИнфПол", ПространствоИмен));
	ДанныеФайлаЭД.Документ.СвИтПрием.ИнфПол = ИнфПол;
	
	ЗаполнитьДанныеДоверенностейВИнформационныхПоляхЭД(Доверенности, ИнфПол, ПространствоИмен);
...
//  ПространствоИмен - Строка - Пространство имен схемы документа
Процедура ЗаполнитьДанныеДоверенностейВИнформационныхПоляхЭД(Доверенности, ИнформационноеПоле, ПространствоИмен)
...
//  КлассификаторЕдиницИзмерения - см. ПолучитьКлассификаторЕдиницИзмерения() - классификатор единиц измерения
// 
// Возвращаемое значение:
...
Функция ЭтоЕдиницаИзмеренияКлассификатора(Код, КлассификаторЕдиницИзмерения) Экспорт
	...
	Область = КлассификаторЕдиницИзмерения.НайтиТекст(
		Код, , КлассификаторЕдиницИзмерения.Области.КодЧисловой, Истина, Истина, Истина, Истина);
	
	Возврат Область <> Неопределено;
	
КонецФункции

// Получить классификатор единиц измерения.
// 
// Возвращаемое значение:
//  Структура из см. Справочники.ЕдиницыИзмерения.Макеты.КлассификаторЕдиницИзмерения
Функция ПолучитьКлассификаторЕдиницИзмерения() Экспорт
	...
	Возврат Справочники[ИмяСправочника].ПолучитьМакет("КлассификаторЕдиницИзмерения");
