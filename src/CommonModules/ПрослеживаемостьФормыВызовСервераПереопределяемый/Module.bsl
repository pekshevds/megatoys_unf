...
Функция СписокНоменклатуры(ПервичныйДокумент, КодТНВЭД, Период) Экспорт
	...
	|	И НоменклатураСправочник.ТоварнаяНоменклатураВЭД = &КодТНВЭД";
...
Функция ПараметрыНоменклатуры(Номенклатура) Экспорт
	...
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Номенклатура, "ТоварнаяНоменклатураВЭД, ЕдиницаИзмерения");
