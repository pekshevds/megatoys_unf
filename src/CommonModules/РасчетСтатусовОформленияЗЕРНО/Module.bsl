...
Функция СоответствуетОрганизации(Реквизиты, Кэш)
	...
	Если Реквизиты.Отгрузка Тогда
	ИначеЕсли Реквизиты.Приемка Тогда
	ИначеЕсли Реквизиты.ВидОперации = Перечисления.ВидыОперацийЗЕРНО.ОформлениеСДИЗЭкспорт Тогда
