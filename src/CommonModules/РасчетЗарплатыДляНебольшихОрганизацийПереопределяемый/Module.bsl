...
Функция ТекстСообщенияОПриближенииКМаксимальноДопустимомуКоличествуРаботающихСотрудников() Экспорт
	...
	Возврат НСтр("ru='В режиме расчета зарплаты для небольшой организации количество работающих сотрудников не может превышать %1.
...
Функция ТекстСообщенияОНевозможностиСоздаватьДокументыПриОтключеннойНастройке() Экспорт
	...
	Возврат НСтр("ru='Создавать документ ""%1"" можно при включенном режиме расчета зарплаты для небольших организаций'");
