...
// 
// Возвращаемое значение:
//  Произвольный, Структура, Неопределено - Текущие параметры авторизации:
...
// Обмен с сервисом распознавания документов.
...
Процедура ОтправитьФайлыИзКаталогаНаРаспознавание(ПараметрыПоиска) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		СтруктураФайл.Вставить("ДатаИзменения", Выборка.ДатаИзменения);
		СтруктураФайл.Вставить("Каталог", Выборка.Каталог);
		СтруктураФайл.Вставить("ДвоичныеДанные", Новый ДвоичныеДанные(Выборка.ПолноеИмяФайла));
