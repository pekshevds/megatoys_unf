...
Процедура ЗаполнитьЦелевоеВремяОперацийПроизводительности() Экспорт
	...
	Попытка
		...
		Для Каждого КлючеваяОперация Из КлючевыеОперации Цикл
			СоздатьИЗаполнитьЦелевоеВремяКлючевойОперации(КлючеваяОперация.Ключ, КлючеваяОперация.Значение);
		КонецЦикла;
...
Процедура СоздатьИЗаполнитьЦелевоеВремяКлючевойОперации(ИмяКлючевойОперации, ЦелевоеВремя = 1, ВыполненаСОшибкой = Ложь)
