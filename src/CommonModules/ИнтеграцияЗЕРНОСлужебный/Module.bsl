...
Функция ПараметрыПреобразования() Экспорт
	...
	РеквизитыТипа = Новый Структура();
	РеквизитыТипа.Вставить("ТипОрганизации", Перечисления.ТипыОрганизацийЗЕРНО.ИндивидульныйПредприниматель);
...
Функция ОрганизацияКонтрагентXDTO(Реквизиты, СообщениеXML, ПредставлениеРевизита = "") Экспорт
	...
	ИначеЕсли Реквизиты.ТипОрганизации = Перечисления.ТипыОрганизацийЗЕРНО.ИндивидульныйПредприниматель Тогда
...
Функция ПроверитьИнтервалыВыполненияЗапроса(ЭлементОчереди, ПараметрыОбмена, ДатаСледующейИтерации)
	...
	Если КоличествоЗапросовЗаМинуту >= ПараметрыОптимизации.КоличествоЗапросовВМинуту Тогда
		ДатаСледующейИтерации = МинимальнаяДата + 1;
		Возврат Ложь;
	КонецЕсли;
