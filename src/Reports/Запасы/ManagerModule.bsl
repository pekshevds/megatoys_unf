...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.Запасы, "ИсторияРезервов");
	Вариант.Описание = НСтр("ru = 'История движений запасов в резерве для заданного заказа покупателя.'");
	Вариант.ФункциональныеОпции.Добавить("РезервированиеЗапасов");
	Вариант.Включен = Ложь;
	Вариант.Размещение.Очистить();
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.Запасы, "ОстаткиРезервов");
	Вариант.Описание = НСтр("ru = 'Остатки запасов в резерве по заданному заказу покупателя.'");
	Вариант.ФункциональныеОпции.Добавить("РезервированиеЗапасов");
	Вариант.Включен = Ложь;
	Вариант.Размещение.Очистить();
