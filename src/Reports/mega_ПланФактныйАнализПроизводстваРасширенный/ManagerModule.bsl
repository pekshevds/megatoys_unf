...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "Основной", 
		НСтр("ru = 'План-фактный анализ производства'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.mega_ПланФактныйАнализПроизводстваРасширенный, "Основной");
	Вариант.Описание = НСтр("ru = 'План-фактный анализ производства (расширенный)'");
