...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	// АПК:216-выкл
	НастройкиВариантов["ПланФактПоРабочемуВремениСотрудников"].Теги = НСтр("ru = 'План,факт,рабочее,временя,сотрудники,отклонение'");
	НастройкиВариантов["ДетальныйПланФактПоРабочемуВремениСотрудников"].Теги = НСтр("ru = 'Детальный,план,факт,рабочее,временя,сотрудники,отклонение'");
	// АПК:216-вкл
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["ПланФактПоРабочемуВремениСотрудников"].СвязанныеПоля, "Сотрудник", "Справочник.Сотрудники");
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["ДетальныйПланФактПоРабочемуВремениСотрудников"].СвязанныеПоля, "Сотрудник", "Справочник.Сотрудники");
