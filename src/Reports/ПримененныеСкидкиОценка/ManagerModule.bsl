...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "ПримененныеСкидкиОценка", 
		НСтр("ru = 'Примененные скидки (оценка)'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант.Описание = НСтр("ru = 'Отчет отображает сведения о предоставленных скидках и итоговой прибыли по товарам со скидкой за определенный период времени.'");
