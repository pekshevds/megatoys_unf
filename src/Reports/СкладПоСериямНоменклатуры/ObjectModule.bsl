...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Товары,Серии номенклатуры'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Товары,Серии номенклатуры'");
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		...
		ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиТекВарианта.Значение.СвязанныеПоля, "СерииНоменклатуры", "Справочник.СерииНоменклатуры",,, Истина);
	КонецЦикла;
