...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru = 'Запасы,Склады,Закупки,Продажи,Номенклатура,Товары,ГТД'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ru = 'Запасы,Склады,Закупки,Продажи,Номенклатура,Товары,ГТД'");
	НастройкиВариантов["ВедомостьГТДРНПТ"].Теги = НСТР("ru = 'Запасы,Склады,Закупки,Продажи,Номенклатура,Товары,ГТД,РНПТ,Прослеживаемость'");
	НастройкиВариантов["ОстаткиГТДРНПТ"].Теги = НСТР("ru = 'Запасы,Склады,Закупки,Продажи,Номенклатура,Товары,ГТД,РНПТ,Прослеживаемость'");
	НастройкиВариантов["ВедомостьРНПТ"].Теги = НСТР("ru = 'Запасы,Склады,Закупки,Продажи,Номенклатура,Товары,РНПТ,Прослеживаемость'");
	НастройкиВариантов["ОстаткиРНПТ"].Теги = НСТР("ru = 'Запасы,Склады,Закупки,Продажи,Номенклатура,Товары,РНПТ,Прослеживаемость'");
