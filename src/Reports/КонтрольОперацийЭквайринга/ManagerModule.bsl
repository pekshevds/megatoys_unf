...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "Основной", 
		НСтр("ru = 'Контроль операций эквайринга'")));
	Результат.Добавить(Новый Структура("Имя, Представление", "Кредит", 
		НСтр("ru = 'Контроль операций по продажам в кредит'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант.ФункциональныеОпции.Добавить("ВестиУчетРасчетовСБанкомЭквайрером");
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.КонтрольОперацийЭквайринга, "Кредит");
	Вариант.Описание = НСтр("ru = 'Отчет отображает сведения для контроля операций по продажам в кредит.'");
	Вариант.ФункциональныеОпции.Добавить("ВестиУчетРасчетовСБанкомЭквайрером");
