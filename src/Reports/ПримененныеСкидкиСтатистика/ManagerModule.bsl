...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "ПримененныеСкидкиСтатистика", 
		НСтр("ru = 'Примененные скидки (статистика)'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант.Описание = НСтр("ru = 'Отчет отображает статистику по использованию различных видов скидок за определенный период времени.'");
