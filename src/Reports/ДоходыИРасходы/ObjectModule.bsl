...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru = 'Главное,Компания,Доходы,Расходы,Направление деятельности'");
	НастройкиВариантов["ДоходыИРасходыПоЗаказам"].Теги = НСТР("ru = 'Компания,Доходы,Расходы,Заказы'");
	НастройкиВариантов["ДинамикаДоходовИРасходов"].Теги = НСТР("ru = 'Компания,Доходы,Расходы,Направление деятельности'");
	НастройкиВариантов["ДоходыИРасходыПоПроектам"].Теги = НСТР("ru = 'Компания,Доходы,Расходы,Проекты'");
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Ведомость"].СвязанныеПоля, "", "Обработка.ЗакрытиеМесяца", , Истина);
