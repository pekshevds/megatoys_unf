...
Процедура ЗаполнитьТаблицуРасшифровкиПоПоказателю(СтруктураПараметров)
	...
	СпособПолученияДанныхИсточника = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтруктураПараметров.Показатель, "СпособПолученияДанныхИсточника");
	
	Если СпособПолученияДанныхИсточника = Перечисления.СпособыПолученияДанныхИсточника.Расширение Тогда
		
		ТаблицаРасшифровка = ПоказателиБизнеса.ПолучитьРасшифровкуПодключаемогоПоказателя(СтруктураПараметров);
		РасшифровкаЗначения.Загрузить(ТаблицаРасшифровка);
