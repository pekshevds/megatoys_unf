...
Процедура ПриКонтекстномОткрытии(Объект, ПолеСвязи, Отборы, Отказ) Экспорт
	...
	Если ПолеСвязи = "Серия" Тогда
		Отборы.Вставить(ПолеСвязи, Объект.Серия);
	КонецЕсли;
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ru = 'Номенклатура,Отгрузки,Запасы,Закупки,Остатки,Продажи,Серии номенклатуры'");
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Основной"].СвязанныеПоля, "Серия", "Справочник.СерииНоменклатуры",,, Истина);
