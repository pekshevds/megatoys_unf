...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ПересеченияСегментаКонтрагентов"].ИмяМакетаОбразца = "ОбразецПересеченияСегментов";
	НастройкиВариантов["ПересеченияСегментаНоменклатуры"].ИмяМакетаОбразца = "ОбразецПересеченияСегментов";
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	СтруктураВарианта = НастройкиВариантов["ПересеченияСегментаКонтрагентов"];
	ОтчетыУНФ.ДобавитьОписаниеПривязки(СтруктураВарианта.СвязанныеПоля, "СегментОтбораКонтрагентов", "Справочник.СегментыКонтрагентов",,, Истина);
	
	СтруктураВарианта = НастройкиВариантов["ПересеченияСегментаНоменклатуры"];
	ОтчетыУНФ.ДобавитьОписаниеПривязки(СтруктураВарианта.СвязанныеПоля, "СегментОтбораНоменклатуры", "Справочник.СегментыНоменклатуры",,, Истина);
