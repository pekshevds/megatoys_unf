...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ВыводитьПроизводство = ПолучитьФункциональнуюОпцию("ИспользоватьПодсистемуПроизводство");
	ПолеТребуетсяДляПроизводства = Новый ПолеКомпоновкиДанных("ТребуетсяДляПроизводства");
	ПолеБудетПроизведено = Новый ПолеКомпоновкиДанных("БудетПроизведено");
	...
	Для Каждого Элемент Из НастройкиОтчета.Выбор.Элементы Цикл
		Если ТипЗнч(Элемент) = Тип("АвтоВыбранноеПолеКомпоновкиДанных") Тогда
			Продолжить;
		КонецЕсли;
		Если НЕ ВыводитьПроизводство И ТипЗнч(Элемент) = Тип("ГруппаВыбранныхПолейКомпоновкиДанных") Тогда
			Для каждого ЭлементГруппы Из Элемент.Элементы Цикл
				Если ЭлементГруппы.Поле = ПолеТребуетсяДляПроизводства
					ИЛИ ЭлементГруппы.Поле = ПолеБудетПроизведено Тогда
						ЭлементГруппы.Использование = Ложь;
				КонецЕсли;
			КонецЦикла;
		КонецЕсли;
		
		Если НЕ ВыводитьПроизводство И (Элемент.Поле = ПолеТребуетсяДляПроизводства
				ИЛИ Элемент.Поле = ПолеБудетПроизведено) Тогда
