...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("АвтоТест") Тогда
		Возврат;
	КонецЕсли;
	Параметры.Свойство("ИНННиз", ИНННиз);
	Параметры.Свойство("КППНиз", КППНиз);
	Параметры.Свойство("ОГРННиз", ОГРННиз);
	Параметры.Свойство("ПолноеНазваниеНиз", ПолноеНазваниеНиз);
	Параметры.Свойство("СокращенноеНазваниеНиз", СокращенноеНазваниеНиз);
	Параметры.Свойство("НСАНиз", НСАНиз);
