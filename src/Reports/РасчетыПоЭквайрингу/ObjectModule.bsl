...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ОсновнойБезРазнесенияПоОперациямОплаты"].Теги = НСтр("ru = 'Деньги,Платежная карта,Безнал,Эквайринг'");
	НастройкиВариантов["Кредит"].Теги = НСтр("tu = 'Деньги,Безнал,Кредит'");
