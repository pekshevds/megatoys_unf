...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если ПараметрКонецПериода.Использование Тогда
		// Режим среза на дату
		НаДату = ПараметрКонецПериода.Значение;
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = 
		НСТР("ru = 'Запасы,Закупки,Склады,Номенклатура,Остатки,Цены'");
	НастройкиВариантов["ОценкаСтоимостиСклада"].Теги = 
		НСтр("ru = 'Запасы,Закупки,Склады,Номенклатура,Остатки,Цены'");
	НастройкиВариантов["ОценкаДвиженийВРозничныхЦенах"].Теги = 
		НСтр("ru = 'Запасы,Склады,Номенклатура,Остатки,Цены,Розница'");
	НастройкиВариантов["ОценкаСтоимостиСкладаВРозничныхЦенах"].Теги = 
		НСтр("ru = 'Запасы,Склады,Номенклатура,Остатки,Цены,Розница'");
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["ОценкаСтоимостиСклада"].СвязанныеПоля, 
		"СтруктурнаяЕдиница", "Справочник.СтруктурныеЕдиницы", Перечисления.ТипыСтруктурныхЕдиниц.Склад);
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["ОценкаСтоимостиСкладаВРозничныхЦенах"].СвязанныеПоля, 
		"СтруктурнаяЕдиница", "Справочник.СтруктурныеЕдиницы", Перечисления.ТипыСтруктурныхЕдиниц.Склад);
