...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["СоставСегментаКонтрагентов"].ИмяМакетаОбразца = "ОбразецСоставСегмента";
	НастройкиВариантов["СоставСегментаНоменклатуры"].ИмяМакетаОбразца = "ОбразецСоставСегмента";
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	СтруктураВарианта = НастройкиВариантов["СоставСегментаКонтрагентов"];
	ОтчетыУНФ.ДобавитьОписаниеПривязки(СтруктураВарианта.СвязанныеПоля, "СегментКонтрагентов", "Справочник.СегментыКонтрагентов",,, Истина);
	
	СтруктураВарианта = НастройкиВариантов["СоставСегментаНоменклатуры"];
	ОтчетыУНФ.ДобавитьОписаниеПривязки(СтруктураВарианта.СвязанныеПоля, "СегментНоменклатуры", "Справочник.СегментыНоменклатуры",,, Истина);
