...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Передача,Комиссия,Продажи'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Передача,Комиссия'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Передача,Переработка'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Передача,Ответхранение'");
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Ведомость"].СвязанныеПоля, "Контрагент", "Документ.ОтчетКомиссионера",, Истина, Истина);
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Остатки"].СвязанныеПоля, "Контрагент", "Документ.ОтчетКомиссионера",, Истина, Истина);
