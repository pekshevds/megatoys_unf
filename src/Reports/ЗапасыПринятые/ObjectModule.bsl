...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Комиссия'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Комиссия'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Переработка,Производство'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ru = 'Запасы,Склады,Закупки,Номенклатура,Ответхранение'");
	НастройкиВариантов["АгентскиеУслуги"].Теги = НСтр("ru = 'Агентские услуги, Платежный агент'");
