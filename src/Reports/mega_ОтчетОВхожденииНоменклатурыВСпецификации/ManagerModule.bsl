...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "Основной", 
		НСтр("ru = 'Отчет о вхождении номенклатуры в спецификации'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.mega_ОтчетОВхожденииНоменклатурыВСпецификации, "Основной");
	Вариант.Описание = НСтр("ru = 'Отчет о вхождении номенклатуры в спецификации.'");
