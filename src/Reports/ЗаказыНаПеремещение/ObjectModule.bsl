...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru = 'Склад,Заказы,Перемещение'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ru = 'Склад,Заказы,Перемещение'");
	НастройкиВариантов["ВедомостьСокращенно"].Теги = НСТР("ru = 'Склад,Заказы,Перемещение'");
	
КонецПроцедуры

Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Ведомость"].СвязанныеПоля, "ЗаказНаПеремещение", "Документ.ЗаказНаПеремещение");
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["ВедомостьСокращенно"].СвязанныеПоля, "ЗаказНаПеремещение", "Документ.ЗаказНаПеремещение");
