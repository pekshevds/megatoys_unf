...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.СоставКомплектов, "Основной");
	Вариант.Описание = НСтр("ru = 'Составы актуальных комплектов.'");
