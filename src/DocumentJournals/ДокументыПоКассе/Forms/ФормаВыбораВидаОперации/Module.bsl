...
Процедура ЗаполнитьДеревоЗначений()
	...
	//    Поступление. Касса.
	СписокОперацийПоступлениеВКассу = Новый СписокЗначений;
	ДвиженияДенежныхСредствВызовСервера.ЗаполнитьСписокВыбораВидовОпераций("ПоступлениеВКассу", СписокОперацийПоступлениеВКассу);
	ПеренестиСписокВДерево(СписокОперацийПоступлениеВКассу, ВеткаПоступление);
	...
	//    Расход. Касса.
	СписокОперацийРасходИзКассы = Новый СписокЗначений;
	ДвиженияДенежныхСредствВызовСервера.ЗаполнитьСписокВыбораВидовОпераций("РасходИзКассы", СписокОперацийРасходИзКассы);
	ПеренестиСписокВДерево(СписокОперацийРасходИзКассы, ВеткаРасход);
