...
Процедура Справка(Команда)
	...
	ПерейтиПоНавигационнойСсылке("https://sbm.1c.ru/about/razdel-dengi/spisok-dokumentov-oplaty/");
	// АПК:534-вкл
...
Процедура ПриходДенег(Команда)
	...
	ОткрытьФорму("Документ.ПриходДенегМП.ФормаОбъекта", , ЭтаФорма, Истина);
...
Процедура РасходДенег(Команда)
	...
	ОткрытьФорму("Документ.РасходДенегМП.ФормаОбъекта", , ЭтаФорма, Истина);
