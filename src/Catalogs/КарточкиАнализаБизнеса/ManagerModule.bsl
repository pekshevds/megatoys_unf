...
// Создает карточку в АнализеБизнеса по переданным параметрам
//
// Параметры:
//  ПараметрыКарточки	 - Структура
//
Процедура СформироватьКарточкуПоПараметрам(ПараметрыКарточки) Экспорт
...
Функция ПолучитьДанныеЦели(ВыборкаРеквизитов)
	...
	МассивПоказателейДляОтбора = ОбщегоНазначенияКлиентСервер.СвернутьМассив(МассивПоказателейДляОтбора);
