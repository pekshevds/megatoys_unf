...
Процедура ПередЗаписью(Отказ)
	...
	//+mega
	ЗаполнитьПараметрыВеденияВзаиморасчетовПоУмолчанию()
	//-mega
КонецПроцедуры
...
//+mega
Процедура ЗаполнитьПараметрыВеденияВзаиморасчетовПоУмолчанию()
	
	СпособЗачетаПредоплатыПоУмолчанию = Перечисления.СпособыЗачетаИРаспределенияПлатежей.Авто; 
	СпособРазнесенияОплатыПоУмолчанию = Перечисления.СпособыЗачетаИРаспределенияПлатежей.Авто;
	ВестиРасчетыПоДоговорам = Истина;
	ВестиРасчетыПоДокументам = Истина;
	ВестиРасчетыПоЗаказам = Ложь;
	ВестиУчетОплатыПоСчетам = Ложь;
	//ВестиУчетОплатыПоНакладным = Ложь;
	//ВестиУчетОплатыПоЗаказам = Ложь;
КонецПроцедуры
//-mega
