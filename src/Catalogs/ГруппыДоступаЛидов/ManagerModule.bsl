...
Функция ГруппаДоступаПоУмолчанию(Пользователь = Неопределено) Экспорт
	...
	ОсновнаяГруппаДоступа = УправлениеНебольшойФирмойПовтИсп.ПолучитьЗначениеПоУмолчаниюПользователя(Пользователь, "ОсновнаяГруппаДоступаЛидов");
...
Функция ПерваяРазрешеннаяГруппаДоступа()
	...
	Возврат Справочники.ГруппыДоступаЛидов.ПустаяСсылка();
