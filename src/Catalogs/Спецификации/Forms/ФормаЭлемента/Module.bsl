...
Процедура ФормулаНоменклатураНачалоВыбора()
	...
	ПараметрыОткрытия.Вставить("ИдентификаторСтрокиСостава",?(ТекущаяСтрока.ИдентификаторСтрокиСостава="",Новый УникальныйИдентификатор(),ТекущаяСтрока.ИдентификаторСтрокиСостава));
...
Процедура СоставФормулаНоменклатураЗавершениеВыбора(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") И ТекущаяСтрока <> Неопределено Тогда
		...
		ВыбранноеЗначение.Свойство("ИдентификаторСтрокиСостава", ТекущаяСтрока.ИдентификаторСтрокиСостава);
...
Процедура ЗаполнитьИдентификаторПоказателяНаСервере()
	...
	ЭтотОбъект.ИдентификаторСтрокиСостава = СсылкаНовогоЭлемента.УникальныйИдентификатор();
