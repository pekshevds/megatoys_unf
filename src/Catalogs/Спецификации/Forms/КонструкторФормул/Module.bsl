...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ИдентификаторСтрокиСостава",ИдентификаторСтрокиСостава);
...
Процедура ОК(Команда)
	...
	Результат.Вставить("ИдентификаторСтрокиСостава", ИдентификаторСтрокиСостава);
...
Процедура БольшеВариантовНажатие(Элемент)
	Если Режим = 2 Тогда
		ПараметрыОткрытия = Новый Структура;
		ПараметрыОткрытия.Вставить("ИдентификаторСтрокиСостава", ИдентификаторСтрокиСостава);
