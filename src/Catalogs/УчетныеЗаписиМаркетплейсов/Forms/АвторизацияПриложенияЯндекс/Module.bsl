...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если (Не ЗавершениеРаботы) И АвторизацияУспешна Тогда
		Оповестить("ОбновитьАвторизациюПриложения", АвторизацияУспешна, ЭтаФорма);
	КонецЕсли;
...
Процедура Авторизовать(Команда)
	...
	Если АвторизацияУспешна Тогда
		...
		Оповестить( "ЯндексАвторизация", ДанныеПриложения, ЭтаФорма );
...
Процедура АвторизоватьНаСервере()
	...
	Если АвторизацияУспешна Тогда
		...
		Если ЗначениеЗаполнено( УчетнаяЗаписьМаркетплейса ) И УчетнаяЗаписьМаркетплейса.ВидМаркетплейса = Перечисления.ВидыМаркетплейсов.МаркетплейсOzon Тогда
