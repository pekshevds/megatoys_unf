...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.ПортСервераВходящейПочты         = 993;
	Элемент.ПортСервераИсходящейПочты        = 465;
	Элемент.ПротоколВходящейПочты            = "IMAP";
...
Функция ОписаниеНастроек(ПрофильИсходящейПочты, ПрофильВходящейПочты)
	...
	Если ПрофильИсходящейПочты <> Неопределено Тогда
		ЗаполнитьЗначенияСвойств(Профиль, ПрофильИсходящейПочты);
