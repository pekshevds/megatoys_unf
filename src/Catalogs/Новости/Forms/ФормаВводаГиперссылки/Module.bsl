...
//  ДополнительныеПараметры - Неопределено - значение, которое было указано при создании объекта ОписаниеОповещения.
//
Процедура ПослеВыбораФайла(ОписаниеФайла, ДополнительныеПараметры = Неопределено) Экспорт

	Если ОписаниеФайла <> Неопределено Тогда
		СтруктураСохраненногоФайла = ПолучитьBase64ИзФайлаСервер(ОписаниеФайла.Адрес);
		КартинкаДанные             = СтруктураСохраненногоФайла.Данные;
		КартинкаРазмер             = СтруктураСохраненногоФайла.Размер;
	КонецЕсли;
