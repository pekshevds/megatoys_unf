...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru='Я'");
	Элемент.ПолноеНаименование = НСтр("ru='Продолжительность работы в дневное время'");
	Элемент.Код = "01";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "РаботаНочныеЧасы";
	Элемент.Наименование = НСтр("ru='Н'");
	Элемент.ПолноеНаименование = НСтр("ru='Продолжительность работы в ночное время'");
	Элемент.Код = "02";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Праздники";
	Элемент.Наименование = НСтр("ru='РВ'");
	Элемент.ПолноеНаименование = НСтр("ru='Продолжительность работы в выходные и нерабочие праздничные дни'");
	Элемент.Код = "03";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Сверхурочные";
	Элемент.Наименование = НСтр("ru='С'");
	Элемент.ПолноеНаименование = НСтр("ru='Продолжительность сверхурочной работы'");
	Элемент.Код = "04";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Вахта";
	Элемент.Наименование = НСтр("ru='ВМ'");
	Элемент.ПолноеНаименование = НСтр("ru='Продолжительность работы вахтовым методом'");
	Элемент.Код = "05";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Командировка";
	Элемент.Наименование = НСтр("ru='К'");
	Элемент.ПолноеНаименование = НСтр("ru='Служебная командировка'");
	Элемент.Код = "06";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ПовышениеКвалификации";
	Элемент.Наименование = НСтр("ru='ПК'");
	Элемент.ПолноеНаименование = НСтр("ru='Повышение квалификации с отрывом от работы'");
	Элемент.Код = "07";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ПовышениеКвалификацииВДругойМестности";
	Элемент.Наименование = НСтр("ru='ПМ'");
	Элемент.ПолноеНаименование = НСтр("ru='Повышение квалификации с отрывом от работы в другой местности'");
	Элемент.Код = "08";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОсновнойОтпуск";
	Элемент.Наименование = НСтр("ru='ОТ'");
	Элемент.ПолноеНаименование = НСтр("ru='Ежегодный основной оплачиваемый отпуск'");
	Элемент.Код = "09";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ДополнительныйОтпуск";
	Элемент.Наименование = НСтр("ru='ОД'");
	Элемент.ПолноеНаименование = НСтр("ru='Ежегодный дополнительный оплачиваемый отпуск'");
	Элемент.Код = "10";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОтпускНаОбучение";
	Элемент.Наименование = НСтр("ru='У'");
	Элемент.ПолноеНаименование = НСтр("ru='Дополнительный отпуск в связи с обучением с сохранением среднего заработка работникам, совмещающим работу с обучением'");
	Элемент.Код = "11";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "СокращенныйДеньОбучающегося";
	Элемент.Наименование = НСтр("ru='УВ'");
	Элемент.ПолноеНаименование = НСтр("ru='Сокращенная продолжительность рабочего времени для обучающихся без отрыва от производства с частичным сохранением заработной платы'");
	Элемент.Код = "12";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОтпускНаОбучениеНеоплачиваемый";
	Элемент.Наименование = НСтр("ru='УД'");
	Элемент.ПолноеНаименование = НСтр("ru='Дополнительный отпуск в связи с обучением без сохранения заработной платы'");
	Элемент.Код = "13";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОтпускПоБеременностиИРодам";
	Элемент.Наименование = НСтр("ru='Р'");
	Элемент.ПолноеНаименование = НСтр("ru='Отпуск по беременности и родам (отпуск в связи с усыновлением новорожденного ребенка)'");
	Элемент.Код = "14";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОтпускПоУходуЗаРебенком";
	Элемент.Наименование = НСтр("ru='ОЖ'");
	Элемент.ПолноеНаименование = НСтр("ru='Отпуск по уходу за ребенком до достижения им возраста трех лет'");
	Элемент.Код = "15";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "НеоплачиваемыйОтпускПоРазрешениюРаботодателя";
	Элемент.Наименование = НСтр("ru='ДО'");
	Элемент.ПолноеНаименование = НСтр("ru='Отпуск без сохранения заработной платы, предоставляемый работнику по разрешению работодателя'");
	Элемент.Код = "16";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "НеоплачиваемыйОтпускПоЗаконодательству";
	Элемент.Наименование = НСтр("ru='ОЗ'");
	Элемент.ПолноеНаименование = НСтр("ru='Отпуск без сохранения заработной платы при условиях, предусмотренных действующим законодательством Российской Федерации'");
	Элемент.Код = "17";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "НеоплачиваемыйДополнительныйОтпуск";
	Элемент.Наименование = НСтр("ru='ДБ'");
	Элемент.ПолноеНаименование = НСтр("ru='Ежегодный дополнительный отпуск без сохранения заработной платы'");
	Элемент.Код = "18";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Болезнь";
	Элемент.Наименование = НСтр("ru='Б'");
	Элемент.ПолноеНаименование = НСтр("ru='Временная нетрудоспособность (кроме случаев, предусмотренных кодом ""Т"") с назначением пособия согласно законодательству'");
	Элемент.Код = "19";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "БолезньБезОплаты";
	Элемент.Наименование = НСтр("ru='Т'");
	Элемент.ПолноеНаименование = НСтр("ru='Временная нетрудоспособность без назначения пособия в случаях, предусмотренных законодательством'");
	Элемент.Код = "20";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "СокращенныйДеньПоЗаконодательству";
	Элемент.Наименование = НСтр("ru='ЛЧ'");
	Элемент.ПолноеНаименование = НСтр("ru='Сокращенная продолжительность рабочего времени против нормальной продолжительности рабочего дня в случаях, предусмотренных законодательством'");
	Элемент.Код = "21";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ВынужденныйПрогул";
	Элемент.Наименование = НСтр("ru='ПВ'");
	Элемент.ПолноеНаименование = НСтр("ru='Время вынужденного прогула в случае признания увольнения, перевода на другую работу или отстранения от работы незаконными с восстановлением на прежней работе'");
	Элемент.Код = "22";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ГосударственныеОбязанности";
	Элемент.Наименование = НСтр("ru='Г'");
	Элемент.ПолноеНаименование = НСтр("ru='Невыходы на время исполнения государственных или общественных обязанностей согласно законодательству'");
	Элемент.Код = "23";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Прогулы";
	Элемент.Наименование = НСтр("ru='ПР'");
	Элемент.ПолноеНаименование = НСтр("ru='Прогулы (отсутствие на рабочем месте без уважительных причин в течение времени, установленного законодательством)'");
	Элемент.Код = "24";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "НеполныйРабочийДеньПоРаботодателю";
	Элемент.Наименование = НСтр("ru='НС'");
	Элемент.ПолноеНаименование = НСтр("ru='Продолжительность работы в режиме неполного рабочего времени по инициативе работодателя в случаях, предусмотренных законодательством'");
	Элемент.Код = "25";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ВыходныеДни";
	Элемент.Наименование = НСтр("ru='В'");
	Элемент.ПолноеНаименование = НСтр("ru='Выходные дни (еженедельный отпуск) и  нерабочие праздничные дни'");
	Элемент.Код = "26";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ДополнительныеВыходныеДниОплачиваемые";
	Элемент.Наименование = НСтр("ru='ОВ'");
	Элемент.ПолноеНаименование = НСтр("ru='Дополнительные выходные дни (оплачиваемые)'");
	Элемент.Код = "27";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ДополнительныеВыходныеДниНеОплачиваемые";
	Элемент.Наименование = НСтр("ru='НВ'");
	Элемент.ПолноеНаименование = НСтр("ru='Дополнительные выходные дни (без сохранения заработной платы'");
	Элемент.Код = "28";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Забастовка";
	Элемент.Наименование = НСтр("ru='ЗБ'");
	Элемент.ПолноеНаименование = НСтр("ru='Забастовка (при условиях и в порядке, предусмотренных законом)'");
	Элемент.Код = "29";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "НеявкиПоНевыясненнымПричинам";
	Элемент.Наименование = НСтр("ru='НН'");
	Элемент.ПолноеНаименование = НСтр("ru='Неявки по невыясненным причинам (до выяснения обстоятельств)'");
	Элемент.Код = "30";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ПростойПоВинеРаботодателя";
	Элемент.Наименование = НСтр("ru='РП'");
	Элемент.ПолноеНаименование = НСтр("ru='Время простоя по вине работодателя'");
	Элемент.Код = "31";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "Простой";
	Элемент.Наименование = НСтр("ru='НП'");
	Элемент.ПолноеНаименование = НСтр("ru='Время простоя по причинам, не зависящим от работодателя и работника'");
	Элемент.Код = "32";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ПростойПоВинеРаботника";
	Элемент.Наименование = НСтр("ru='ВП'");
	Элемент.ПолноеНаименование = НСтр("ru='Время простоя по вине работника'");
	Элемент.Код = "33";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОтстранениеОтРаботыСОплатой";
	Элемент.Наименование = НСтр("ru='НО'");
	Элемент.ПолноеНаименование = НСтр("ru='Отстранение от работы (недопущение к работе) с оплатой (пособием) в соответствии с законодательством'");
	Элемент.Код = "34";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ОтстранениеОтРаботыБезОплаты";
	Элемент.Наименование = НСтр("ru='НБ'");
	Элемент.ПолноеНаименование = НСтр("ru='Отстранение от работы (недопущение к работе) по причинам, предусмотренным законодательством, без начисления заработной платы'");
	Элемент.Код = "35";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ЗадержкаВыплатыЗаработнойПлаты";
	Элемент.Наименование = НСтр("ru='НЗ'");
	Элемент.ПолноеНаименование = НСтр("ru='Время приостановки работы в случае задержки выплаты заработной платы'");
	Элемент.Код = "36";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "РаботаВечерниеЧасы";
	Элемент.Наименование = НСтр("ru='ВЧ'");
	Элемент.ПолноеНаименование = НСтр("ru='Устарело. Продолжительность работы в вечернее время'");
	Элемент.Код = "99";
