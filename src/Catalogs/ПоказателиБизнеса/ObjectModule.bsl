...
Процедура ПередЗаписью(Отказ)
	...
	Если ТипПоказателя = Перечисления.ТипыПоказателейБизнеса.Формула Тогда
		
		Ошибки = Новый Массив;
		ПоказателиБизнесаФормулы.ПроверитьФормулуНаБесконечныйЦикл(Ссылка, Родитель, СтрокаФормулы, Ошибки);
	...
	Если ТипПоказателя = Перечисления.ТипыПоказателейБизнеса.Формула
		ИЛИ ТипПоказателя = Перечисления.ТипыПоказателейБизнеса.Группа Тогда
		
		ИсточникДанных = Неопределено;
		СпособПолученияДанныхИсточника = Перечисления.СпособыПолученияДанныхИсточника.ПустаяСсылка();
...
Функция НеобходимоСоздатьИсточник()
	...
	НеобходимоСоздатьИсточник = (ВидОтчета = Перечисления.ВидыФинансовыхОтчетов.ДоходыРасходы 
								...
								И НЕ СпособПолученияДанныхИсточника = Перечисления.СпособыПолученияДанныхИсточника.Расширение;
