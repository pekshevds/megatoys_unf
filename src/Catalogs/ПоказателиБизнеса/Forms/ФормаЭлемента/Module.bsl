...
&НаКлиенте
Процедура СпособПолученияДанныхИсточникаПриИзменении(Элемент)
...
Процедура БольшеВариантовНажатие(Элемент)
	...
	Если Объект.СпособПолученияДанныхИсточника = ПредопределенноеЗначение("Перечисление.СпособыПолученияДанныхИсточника.Расширение") Тогда
		Если Объект.Ссылка.Пустая() Тогда
			ЗаполнитьИдентификаторПоказателяНаСервере()
		КонецЕсли;
		ПараметрыОткрытия = Новый Структура;
		ПараметрыОткрытия.Вставить("ИдентификаторПоказателя", Объект.ИдентификаторПоказателя);
...
Процедура ОбновитьВидимостьДоступность()
	...
	ЭтоПодключаемыйПоказатель = Объект.СпособПолученияДанныхИсточника = ПредопределенноеЗначение("Перечисление.СпособыПолученияДанныхИсточника.Расширение");
	...
	Элементы.ГруппаПодсказкаДляПользователя.Видимость = ЭтоПодключаемыйПоказатель;
	Элементы.ИсточникДанных.Видимость = НЕ ЭтоПодключаемыйПоказатель;
	Элементы.Коэффициент.Видимость = НЕ ЭтоПодключаемыйПоказатель;
...
Процедура ЗаполнитьИдентификаторПоказателяНаСервере()
	...
	Объект.ИдентификаторПоказателя = СсылкаНовогоЭлемента.УникальныйИдентификатор();
