...
Процедура ПриЗаписи(Отказ)
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ТекстСообщения = НСтр("ru='Не удалось записать информацию о виде платежной карты (%1) в справочнике ""Виды платежных карт""'");
...
Процедура ПроверитьДоговор(Отказ)
	...
	Если НЕ ДоговорПодходит Тогда
		...
		Текст = НСтр("ru = 'В выбранном договоре должен быть установлен флаг ""Это договор эквайринга""'");
		ОбщегоНазначения.СообщитьПользователю(
			Текст,
			ЭтотОбъект,
			"Договор",
