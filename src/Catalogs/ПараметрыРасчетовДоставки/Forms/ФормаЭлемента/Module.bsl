...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбнаруженыДублиИдентификаторов() Тогда
		ТекстОшибки = НСтр("ru = 'Параметр расчета доставки с таким наименованием уже существует.
		|Измените наименование параметра.'");
		ОбщегоНазначения.СообщитьПользователю(ТекстОшибки, , "Объект.Наименование", , Отказ);
		Возврат;
	КонецЕсли;
...
&НаСервере
Функция ОбнаруженыДублиИдентификаторов()
	...
	|ГДЕ
	|	ПараметрыРасчетовДоставки.Идентификатор = &Идентификатор
	|	И ПараметрыРасчетовДоставки.Ссылка <> &Ссылка";
