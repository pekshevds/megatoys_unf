...
Процедура ПараметрыРасчетовВыборЗадержка()
	...
	ПараметрыВыбораРасчетов = Новый Структура();
	ПараметрыВыбораРасчетов.Вставить("Идентификатор", СтрокаТабличнойЧасти.Идентификатор);
	ПараметрыВыбораРасчетов.Вставить("Синоним", СтрокаТабличнойЧасти.Синоним);
	ОповеститьОВыборе(ПараметрыВыбораРасчетов);
...
Процедура Выбрать(Команда)
	...
	Если СтрокаТабличнойЧасти<>Неопределено И СтрокаТабличнойЧасти.ПолучитьЭлементы().Количество()=0 Тогда
		ВыбранныйПараметр = Новый Структура();
		ВыбранныйПараметр.Вставить("Идентификатор",СтрокаТабличнойЧасти.Идентификатор);
		ВыбранныйПараметр.Вставить("Синоним",СтрокаТабличнойЧасти.Синоним);
		ОповеститьОВыборе(ВыбранныйПараметр);
	КонецЕсли; 
