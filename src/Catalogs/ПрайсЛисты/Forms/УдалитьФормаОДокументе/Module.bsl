...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("Индивидуальный",				Объект.УдалитьИндивидуальный);
	Параметры.Свойство("Организация",					Объект.Организация);
	Параметры.Свойство("Описание",						Объект.Описание);
	Параметры.Свойство("УказатьКонтактыОтветственного",	Объект.УказатьКонтактыОтветственного);
	...
	Если Параметры.Свойство("ОтключитьРедактированиеСведений") Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "УказатьКонтактыОтветственного",	"Доступность",		Ложь);
	...
	Иначе
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "УказатьКонтактыОтветственного",	"ТолькоПросмотр",	НЕ Объект.УдалитьИндивидуальный);
...
Процедура ОК(Команда)
	...
	Результат.Вставить("УказатьКонтактыОтветственного", Объект.УказатьКонтактыОтветственного);
