...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПравоДобавленияНового Тогда
		РаботаСОтборами.ВосстановитьНастройкиОтборов(ЭтотОбъект, Список, , , Новый Структура("ОтборАвтор", "ОтборВариантПечатиПрайсЛиста", "ОтборИерархияСодержимого"), , Ложь);
	...
	Иначе
		РаботаСОтборамиКлиентСервер.УстановитьОтображениеКомандыСброситьВсеОтборы(ЭтаФорма);
	КонецЕсли;
...
Процедура ИзменитьРабочийПрайсЛистОрганизации(РабочийПрайсЛистОрганизации)
	...
	РегистрыСведений.НастройкиПользователей.Установить(РабочийПрайсЛистОрганизации, "РабочийПрайсЛистОрганизации");
	ДинамическиеСпискиУНФ.ВыделитьЖирнымОсновнойЭлемент(РабочийПрайсЛистОрганизации, Список);
