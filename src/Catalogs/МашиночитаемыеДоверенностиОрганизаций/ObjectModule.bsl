...
Процедура ПередЗаписью(Отказ)
	...
	Если ДвоичныеДанные <> Неопределено Тогда
		...
		Если Не Справочники.МашиночитаемыеДоверенностиОрганизаций.ЭтоПередоверие(РезультатЧтения) Тогда
	...
	Если Не ЗначениеЗаполнено(ВариантЗаполненияПолномочий) Тогда
		...
		Если МашиночитаемыеДоверенности.ФорматМЧДПоддерживаетКлассификаторПолномочий(ВерсияФорматаМЧД) Тогда
...
Процедура ЗаписатьВЖурнал(Отказ) Экспорт
	...
	Для Каждого ПредставительОбъекта Из СведенияФайла.Представители Цикл
		...
		ИначеЕсли ПредставительОбъекта.ТипУполномоченногоПредставителя = "ЮЛ" Тогда
			...
			ЛицоБезДоверенности.СНИЛС = ПредставительОбъекта.ПредставительФЛ_СНИЛС;
			ЛицоБезДоверенности.ИНН = ПредставительОбъекта.ПредставительФЛ_ИНН;
