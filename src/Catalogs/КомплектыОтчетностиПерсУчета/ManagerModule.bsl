...
Функция СкопироватьПачкиПрошлогоПериода(Организация, ОтчетныйПериод, МассивФизЛиц = Неопределено) Экспорт
	...
	НомерПачки = УчетСтраховыхВзносовУНФ.ПолучитьСледующийНомерПачки(Организация, ОтчетныйПериод);
...
Функция МассивПачекПрошлогоПериода(Организация, ОтчетныйПериод, МассивФизЛиц = Неопределено) Экспорт
	...
	|			И (КомплектыОтчетностиПерсучета.СостояниеКомплекта = ЗНАЧЕНИЕ(Перечисление.СостояниеКомплектаОтчетностиПерсучетаУНФ.СведенияКомплектаРазнесеныПоЛицевымСчетам))
