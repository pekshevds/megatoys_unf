...
Процедура СформироватьСведенияКвартальнойОтчетности(РСВКомплекта, УчитыватьИсправления = Истина)Экспорт
	...
	ТаблицаИсходныхСЗВ = УчетСтраховыхВзносовУНФ.СформироватьПачкиДокументовСЗВ(?(ОписьПачекСЗВОбъект = Неопределено, ПачкаРазделов6, ОписьПачекСЗВОбъект), '00010101', УчитыватьИсправления, Истина, МассивДокументовКомплекта,, ОтчетныйПериод); 
	...
	СостояниеКомплекта = Перечисления.СостояниеКомплектаОтчетностиПерсучетаУНФ.КомплектСформированНоНеОтправлен;
...
Функция СформироватьКорректирующиеПачки(ОписьПачекСЗВОбъект, КорректируемыйПериод, МассивПачек, МассивФизЛиц, УчитыватьИсправления = Ложь, ЗаменятьСуществующиеПачки = Истина)
	Возврат  УчетСтраховыхВзносовУНФ.СформироватьПачкиДокументовСЗВ(ОписьПачекСЗВОбъект, КорректируемыйПериод, УчитыватьИсправления, ЗаменятьСуществующиеПачки, МассивПачек, МассивФизЛиц);																	 																	  
КонецФункции
...
Функция НовыйОписьАДВ(Организация, ОтчетныйПериод)
	...
	УчетСтраховыхВзносовУНФ.ПроставитьНомерПачки(ОписьОбъект);
...
Процедура ПерераспределитьВзносыЗаПериод(КорректирующиеСведения, ПериодРасчета, СравниватьСТекущимиДанными = Ложь, ДанныеИзменены = Ложь)	
	...
	УчетСтраховыхВзносовУНФ.СформироватьВТСДаннымиОВзносахПоКатегориям(МенеджерВТ, Организация, ПериодРасчета, ДатаАктуальности, КорректирующиеСведения, МассивПачек, Истина);
