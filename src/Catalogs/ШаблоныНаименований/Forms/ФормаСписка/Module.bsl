...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("КатегорияНоменклатуры") Тогда
		...
		Если Не Параметры.Отбор.Свойство("Владелец") Тогда
			Параметры.Отбор.Вставить("Владелец", КатегорияНоменклатуры);
		КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(КатегорияНоменклатуры) Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "НастройкаПорядкаЭлементов", "Видимость", Ложь);
	КонецЕсли;
