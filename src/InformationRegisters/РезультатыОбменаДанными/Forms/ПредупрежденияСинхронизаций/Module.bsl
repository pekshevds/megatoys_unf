...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Поле Из МассивПолей Цикл
		...
		ПолеОграниченияПорядка = Список.Поля.Добавить(Тип("ПолеНабораДанныхСхемыКомпоновкиДанных"));
		ПолеОграниченияПорядка.Поле = Поле;
		ПолеОграниченияПорядка.ПутьКДанным = Поле;
		ПолеОграниченияПорядка.ОграничениеИспользования.Порядок = Истина;
		ПолеОграниченияПорядка.ОграничениеИспользованияРеквизитов.Порядок = Истина;
