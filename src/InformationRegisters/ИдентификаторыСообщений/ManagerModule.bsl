...
// Получаем все идентификаторы по Учетной записи
//
// Параметры:
//  УчетнаяЗапись - СправочникСсылка.УчетныеЗаписиЭлектроннойПочты
// 
// Возвращаемое значение:
//  Соответствие - ИдентификаторСообщения и Событие.
Функция ОтправленныеСобытияПоВсемИдентификаторамСообщений(Знач УчетнаяЗапись) Экспорт
...
Функция ИдентификаторыПослеДатыОтправления(Знач УчетнаяЗапись, Знач ПослеДатыОтправления) Экспорт
	...
	|ГДЕ
	|	ИдентификаторыСообщений.УчетнаяЗапись = &УчетнаяЗапись
	|	И ИдентификаторыСообщений.Событие.НачалоСобытия >= &ПослеДатыОтправления");
	Запрос.УстановитьПараметр("УчетнаяЗапись", УчетнаяЗапись);
