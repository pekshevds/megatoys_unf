...
Функция ТекущиеНастройки() Экспорт
	...
	Результат.Вставить("ПомечатьДокументОбработаннымПриПрикрепленииИзображения", Истина);
	...
	// Потому после чтения следует незаполненные настройки привести к значениям по-умолчанию
