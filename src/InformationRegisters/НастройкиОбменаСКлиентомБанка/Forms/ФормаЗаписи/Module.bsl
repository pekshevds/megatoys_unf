...
Процедура ВыборФайлаЗавершение(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если ВыбранныеФайлы <> Неопределено
		...
		Если ДополнительныеПараметры.Текст = НСтр("ru = 'загрузки'") Тогда
			Модифицированность = Запись.ФайлЗагрузки <> ПолноеИмяФайла;
...
Процедура ОрганизацияПриИзмененииСервер(БанковскийСчет,Организация, ВалютаРегламентированногоУчета)
	...
	УчетДенежныхСредствСервер.УстановитьБанковскийСчет(БанковскийСчет,Организация, ВалютаРегламентированногоУчета);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Программа.СписокВыбора.ЗагрузитьЗначения(УчетДенежныхСредствСервер.СписокСовместимыхПрограммКлиентовБанка(Истина));
