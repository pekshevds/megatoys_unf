...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГоловнаяОрганизация = РегламентированнаяОтчетность.ГоловнаяОрганизация(Запись.Организация); // Используется в связях параметров выбора регистрации в НО
	ФизическоеЛицо      = НЕ ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЭтоЮрЛицо(Запись.Организация);
...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	ГоловнаяОрганизация = ПолучитьГоловнуюОрганизацию(Запись.Организация);
	ФизическоеЛицо      = НЕ ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.ЭтоЮрЛицо(Запись.Организация);
