...
Процедура ОбновитьТекущиеКадровыеДанныеСотрудников(Документ = Неопределено) Экспорт
	...
	|	ПриемНаРаботуУНФ.Организация КАК Организация,
	|	ПриемНаРаботуУНФ.Период КАК ДатаПриема
	...
	|				,
	|				&Условие
	|					И Регистратор ССЫЛКА Документ.ПриемНаРаботуУНФ) КАК ПриемНаРаботуУНФ
	|		ПО (ПриемНаРаботуУНФ.Сотрудник = Сотрудники.Ссылка)
	|			И (&Условие)
	|ГДЕ
	...
	|			,
	|			&Условие
	|				И Регистратор ССЫЛКА Документ.УвольнениеУНФ) КАК Сотрудники
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	Пока Выборка.Следующий() Цикл
		Запись = РегистрыСведений.ТекущиеКадровыеДанныеСотрудниковУНФ.СоздатьМенеджерЗаписи();
