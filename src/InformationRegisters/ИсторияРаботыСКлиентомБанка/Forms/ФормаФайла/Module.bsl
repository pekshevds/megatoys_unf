...
Процедура ЗагрузитьСнова(Команда)
	...
	ПараметрыОткрытияФормы.Вставить("АдресФайлаКОбработке", АдресФайлаКОбработке);
	ПараметрыОткрытияФормы.Вставить("БанковскийСчет", Параметры.БанковскийСчет);
	ПараметрыОткрытияФормы.Вставить("Организация", Параметры.Организация);
	ПараметрыОткрытияФормы.Вставить("Период", Параметры.Период);
	ПараметрыОткрытияФормы.Вставить("РежимПоУмолчанию", "ГруппаЗагрузка");
	
	Если РасчетыРаботаСФормамиВызовСервера.ПроверитьИспользованиеКлиентБанкаБП() Тогда
		ОткрытьФорму("Обработка.КлиентБанк.Форма.Форма", ПараметрыОткрытияФормы);
	Иначе
		ОткрытьФорму("Обработка.КлиентБанкУНФ.Форма.ФормаЗагрузка", ПараметрыОткрытияФормы);
	КонецЕсли;
