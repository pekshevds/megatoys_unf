...
Процедура ОбновитьВидимость()
	...
	Если РежимТестирования Тогда
		Элементы.Пример.Заголовок = НСтр("ru = 'Выйти из режима тестирования'");
	Иначе
		Элементы.Пример.Заголовок = НСтр("ru = 'Попробовать в режиме тестирования'");
	КонецЕсли;
	
	Элементы.ГруппаПример.Видимость = РежимТестирования;
	Элементы.ГруппаТестирование.Видимость = РежимТестирования;
	Элементы.ИскатьПокупателя.Видимость = РежимТестирования;
