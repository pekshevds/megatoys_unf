...
Процедура ОбновитьРезультатОбработкиОбсуждений()
	...
	РезультатОбработки = РегистрыСведений.СобытияОбменаУпралениеПерсоналом.СобытиеОбмена(Приложение, Событие);
...
Функция ОтборЖурналаРегистрации()
	...
	Приложение = Перечисления.ПриложенияДляИнтеграции.КабинетСотрудника;
	РезультатОбработки = РегистрыСведений.СобытияОбменаУпралениеПерсоналом.СобытиеОбмена(Приложение, ВидСобытия);
