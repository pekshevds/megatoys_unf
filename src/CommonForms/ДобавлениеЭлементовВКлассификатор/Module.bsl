...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокВерсий 			= ВерсииСписковОтчета(ВидОбъекта + "." + ИсточникДанных);
...
//
// Параметры: 
//  ПолноеИмяОбъекта - Строка - идентификатор отчета для которого нужно вернуть версии списков
//
// Возвращаемое значение: 
//  СписокЗначений - версии списков отчета
//
&НаСервере
Функция ВерсииСписковОтчета(ПолноеИмяОбъекта)
