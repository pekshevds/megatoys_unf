...
Процедура ЗаполнитьДолги()
	...
	|					ИЛИ ВременнаяТаблицаРасчетыПоЭквайрингуОстаткиМинусДвиженияДокумента.ВидОплаты = ЗНАЧЕНИЕ(Перечисление.ВидыБезналичныхОплат.ВыдачаНаличных)
	|				ТОГДА ВременнаяТаблицаРасчетыПоЭквайрингуОстаткиМинусДвиженияДокумента.СуммаВалОстаток
	|			ИНАЧЕ 0
	...
	|	ОтобранныеДолги.ВидОплаты КАК ВидОплаты
	...
	|	ВременнаяТаблицаРасчетыПоЭквайрингуОстатки.ВидОплаты КАК ВидОплаты,
	...
	|	ТаблицаОтобранныеДолги.ВидОплаты,
	...
	|	РасчетыПоЭквайрингуОстатки.ВидОплаты,
	|	ВЫБОР
	|		КОГДА РасчетыПоЭквайрингуОстатки.ЭквайринговыйТерминал.СобственныеНастройкиНалоговогоУчета
	|			ТОГДА РасчетыПоЭквайрингуОстатки.ЭквайринговыйТерминал.НалогообложениеНДС
	|		ИНАЧЕ &НалогообложениеНДС
