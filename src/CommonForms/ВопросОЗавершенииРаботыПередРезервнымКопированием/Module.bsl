...
// Обработка оповещения события см. ОблачныйАрхив20Клиент.ИмяСобытияОповещенияОбновитДиалогВопросОЗавершенииРаботы
//
// Параметры:
//  ИмяСобытия - Строка
//  Параметр - Структура:
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = ОблачныйАрхив20Клиент.ИмяСобытияОповещенияОбновитДиалогВопросОЗавершенииРаботы() Тогда
