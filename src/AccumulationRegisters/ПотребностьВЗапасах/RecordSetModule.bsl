...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Иначе
		...
		// Текущее состояние набора и текущее состояние изменений помещаются во временную таблицу "ДвиженияПотребностьВЗапасахПередЗаписью",
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|		ДвиженияПотребностьВЗапасахПередЗаписью.Склад КАК Склад,
	...
	|		ДвиженияПотребностьВЗапасахПередЗаписью.ЗаказНаПроизводство КАК ЗаказНаПроизводство,
