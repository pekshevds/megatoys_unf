...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ЭлементБлокировки = Блокировка.Добавить("РегистрНакопления.ЗапасыИАгентскиеУслугиПринятые.НаборЗаписей");
	...
	Если НЕ СтруктураВременныеТаблицы.Свойство("ДвиженияЗапасыПринятыеИзменение") ИЛИ
		...
		|	ВЫБОР
		|		КОГДА ЗапасыИАгентскиеУслугиПринятые.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
		|			ТОГДА ЗапасыИАгентскиеУслугиПринятые.Количество
		|		ИНАЧЕ -ЗапасыИАгентскиеУслугиПринятые.Количество
		|	КОНЕЦ КАК КоличествоПередЗаписью,
		|	ВЫБОР
		|		КОГДА ЗапасыИАгентскиеУслугиПринятые.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
		|			ТОГДА ЗапасыИАгентскиеУслугиПринятые.СуммаРасчетов
		|		ИНАЧЕ -ЗапасыИАгентскиеУслугиПринятые.СуммаРасчетов
		...
		|ГДЕ
		|	ЗапасыИАгентскиеУслугиПринятые.Регистратор = &Регистратор
		|	И &Замещение");
	...
	Иначе
		...
		// Текущее состояние набора и текущее состояние изменений помещаются во временную таблицу "ДвиженияЗапасыПринятыеПередЗаписью",
		...
		|
		|ВЫБРАТЬ
		|	ЗапасыИАгентскиеУслугиПринятые.НомерСтроки,
		|	ЗапасыИАгентскиеУслугиПринятые.Организация,
		|	ЗапасыИАгентскиеУслугиПринятые.Номенклатура,
		|	ЗапасыИАгентскиеУслугиПринятые.Характеристика,
		|	ЗапасыИАгентскиеУслугиПринятые.Партия,
		|	ЗапасыИАгентскиеУслугиПринятые.Контрагент,
		|	ЗапасыИАгентскиеУслугиПринятые.Договор,
		|	ЗапасыИАгентскиеУслугиПринятые.Заказ,
		|	ЗапасыИАгентскиеУслугиПринятые.ТипПриемаПередачи,
		|	ВЫБОР
		|		КОГДА ЗапасыИАгентскиеУслугиПринятые.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
		|			ТОГДА ЗапасыИАгентскиеУслугиПринятые.Количество
		|		ИНАЧЕ -ЗапасыИАгентскиеУслугиПринятые.Количество
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|	ИЗ
	|		РегистрНакопления.ЗапасыИАгентскиеУслугиПринятые КАК ДвиженияЗапасыПринятыеПриЗаписи
	|	ГДЕ
