...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если НЕ ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СтруктураВременныеТаблицы, "ДвиженияПрослеживаемыеТоварыИзменение", Ложь) Тогда
		...
		|	ПрослеживаемыеТовары.Комплектующие КАК Комплектующие //BG
	...
	Иначе
		...
		|	ДвиженияПрослеживаемыеТоварыИзменение.Комплектующие КАК Комплектующие //BG
		|ПОМЕСТИТЬ ДвиженияПрослеживаемыеТоварыПередЗаписью
		|ИЗ
		...
		|	ПрослеживаемыеТовары.Комплектующие //BG
		|ИЗ
		|	РегистрНакопления.ПрослеживаемыеТовары КАК ПрослеживаемыеТовары
		|ГДЕ
		|	ПрослеживаемыеТовары.Регистратор = &Регистратор
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|		ДвиженияПрослеживаемыеТоварыПередЗаписью.Комплектующие КАК Комплектующие, //BG
	...
	|		ДвиженияПрослеживаемыеТоварыПриЗаписи.Комплектующие, //BG
	|		0,
	|		ВЫБОР
	...
	|	ДвиженияПрослеживаемыеТоварыИзменение.Комплектующие //BG
	|
	|ИМЕЮЩИЕ
