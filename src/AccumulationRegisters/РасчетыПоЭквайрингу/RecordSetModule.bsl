...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Иначе
		...
		// Текущее состояние набора и текущее состояние изменений помещаются во временную таблицу "ДвиженияРасчетыПоЭквайрингуПередЗаписью",
		...
		|	ДвиженияРасчетыПоЭквайрингуИзменение.ВидОплаты,
		...
		|	РегистрНакопленияРасчетыПоЭквайрингу.ВидОплаты,
		|	ВЫБОР
...
Процедура ПриЗаписи(Отказ, Замещение)
  ...
  ИЛИ НЕ ДополнительныеСвойства.ДляПроведения.Свойство("СтруктураВременныеТаблицы") Тогда
	...
	|		ДвиженияРасчетыПоЭквайрингуПередЗаписью.ВидОплаты КАК ВидОплаты,
	...
	|		ДвиженияРасчетыПоЭквайрингуПриЗаписи.ВидОплаты,
	|		0,
	|		ВЫБОР
