...
Функция ВыполнитьЗапросВФоне(ИнтернетПоддержкаПодключена, ПараметрыОперации)
	...
	Задание.Наименование = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		"%1: %2.",
		ИмяСервисаДоставки(ЭтоКурьерскаяДоставка),
...
Функция ИмяСервисаДоставки(ЭтоКурьерскаяДоставка)
	
	Возврат ?(ЭтоКурьерскаяДоставка, ИмяСервисаДоставки1СКурьер(), ИмяСервисаДоставки1СДоставка());
