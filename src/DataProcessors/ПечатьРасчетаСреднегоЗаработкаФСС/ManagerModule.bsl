...
Процедура ВывестиТабличныйДокументРасчетаСреднегоЗаработка(ДанныеДокумента, ОбъектыПечати, ТабличныйДокумент, ВыводитьЗаголовок, НомерТаблицыРазделителя)
	...
	ИспользоватьДниБолезниУходаЗаДетьми = ДанныеДокумента.ПараметрыРасчета.ИспользоватьДниБолезниУходаЗаДетьми;
	ПрименятьМаксимальныйСреднедневной  = УчетПособийСоциальногоСтрахованияКлиентСервер.ПрименятьМаксимальныйСреднедневнойБезУчетаИсключаемыхПериодов(
	...
	ОбластиМакета = ОбластиМакета(
		...
		ПрименятьМаксимальныйСреднедневной);
	...
	ИначеЕсли ИспользоватьДниБолезниУходаЗаДетьми Или ПрименятьМаксимальныйСреднедневной Тогда	
...
Процедура ВывестиТабличныйДокументРасчетаСреднегоЗаработкаКомпактный(ДанныеДокумента, ОбъектыПечати, ТабличныйДокумент)
	...
	ОбластиМакета = ОбластиМакета(
		...
		ДанныеДокумента.ПараметрыРасчета.ПрименятьПредельнуюВеличину,
		УчетПособийСоциальногоСтрахованияКлиентСервер.ПрименятьМаксимальныйСреднедневнойБезУчетаИсключаемыхПериодов(ДанныеДокумента.ПараметрыРасчета));
...
Функция ОбластиМакета(ИспользоватьДниБолезниУходаЗаДетьми, ПрименятьПредельнуюВеличину, ПрименятьМаксимальныйСреднедневной)
