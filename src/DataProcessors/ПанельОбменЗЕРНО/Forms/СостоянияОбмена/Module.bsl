...
Процедура ПроверитьНастройкиРегламентныхЗаданийОбмена(РезультатЗапроса)
	...
	Элементы["Группа" + ИмяЭлемента].Видимость = Не (РезультатЗапроса[ИдентификаторПроблемы].Пустой()
		Или ИнтеграцияЗЕРНО.РегЗаданияНастроены(РезультатЗапроса, ИдентификаторПроблемы));
	Если Элементы["Группа" + ИмяЭлемента].Видимость Тогда
...
Процедура ПроверитьНастройкуСертификатаНаСервере(РезультатЗапроса)
	...
	Элементы["Группа" + ИмяЭлемента].Видимость = ИнтеграцияЗЕРНО.РегЗаданияНастроены(РезультатЗапроса, ИдентификаторПроблемы, Ложь);
...
Процедура СброситьРазмерыИПоложениеОкна()
	...
	Если ПравоДоступа("СохранениеДанныхПользователя", Метаданные) Тогда
		ХранилищеСистемныхНастроек.Удалить("Обработка.ПанельОбменЗЕРНО.Форма.СостоянияОбмена", "", ИмяПользователя);
	КонецЕсли;
