...
Процедура ВыполнитьПолучениеДанныхПоДоговорамОбслуживания(Параметры, Результат, Ошибки)
	...
	СписокРасшифровкаБиллинга.Колонки.Добавить("ДобавлятьПериодВСодержание", Новый ОписаниеТипов("Булево"));
	...
	|	ВТДоговорыОбслуживания.ДатаВыставленияДокументов КАК ДатаВыставленияДокументов,
	...
	|	ТарифныеПланыДоговоровОбслуживанияУчетНоменклатуры.ВключатьВСчет КАК ВключатьВСчет,
	|	ВЫБОР
	...
	|	0 КАК Наценка,
	|	ТарифныеПланыДоговоровОбслуживанияУчетНоменклатуры.ФормированиеЦены КАК ФормированиеЦены,
	|	ТарифныеПланыДоговоровОбслуживанияУчетНоменклатуры.ПредставлениеВСчете КАК ПредставлениеВСчете,
	|	ТарифныеПланыДоговоровОбслуживанияУчетНоменклатуры.ДобавлятьПериодВСодержание КАК ДобавлятьПериодВСодержание
	...
	|	ТарифныеПланыДоговоровОбслуживанияУчетЗатрат.ДобавлятьПериодВСодержание
	|ИЗ
	...
	|	ВТУсловияПоПозициямТарифныхПланов.ДобавлятьПериодВСодержание КАК ДобавлятьПериодВСодержание
	|ПОМЕСТИТЬ ВТДоговорыОбслуживанияАбонентскаяЧасть
	|ИЗ
	...
	|	ВТУсловияПоПозициямТарифныхПланов.ДобавлятьПериодВСодержание
	|ИЗ
	|	ВТДоговорыКонтрагенты КАК ВТДоговорыКонтрагенты
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТУсловияПоПозициямТарифныхПланов КАК ВТУсловияПоПозициямТарифныхПланов
	|		ПО ВТДоговорыКонтрагенты.ТарифныйПлан = ВТУсловияПоПозициямТарифныхПланов.ТарифныйПлан
	...
	|	ВыполнениеДоговоровОбслуживанияОбороты.ОбъектДоговораОбслуживания КАК ОбъектДоговораОбслуживания,
	|	ВыполнениеДоговоровОбслуживанияОбороты.Характеристика КАК Характеристика,
	|	ВыполнениеДоговоровОбслуживанияОбороты.УказанаСтоимость КАК УказанаСтоимость,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТОбороты.Договор КАК Договор,
	|	ВТОбороты.ТарифныйПлан КАК ТарифныйПлан,
	|	ВТОбороты.ОбъектДоговораОбслуживания КАК ОбъектДоговораОбслуживания,
	|	ВТОбороты.Характеристика КАК Характеристика,
	|	ВТОбороты.Количество КАК КоличествоСЦеной,
	|	ВТОбороты.Сумма КАК СуммаСЦеной,
	|	0 КАК КоличествоБезЦены,
	|	0 КАК СуммаБезЦены,
	|	0 КАК ЦенаПоВидуЦен,
	|	ВТОбороты.ПредставлениеВСчете КАК ПредставлениеВСчете,
	|	ВТОбороты.ВключатьВСчет КАК ВключатьВСчет
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТСчетаПоДоговорамОбслуживания.Договор КАК Договор,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.Договор, ВТОборотыОказано.Договор) КАК Договор,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.ОбъектДоговораОбслуживания, ВТОборотыОказано.ОбъектДоговораОбслуживания) КАК ОбъектДоговораОбслуживания,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.Характеристика, ВТОборотыОказано.Характеристика) КАК Характеристика,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.ПредставлениеВСчете, ВТОборотыОказано.ПредставлениеВСчете) КАК ПредставлениеВСчете,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.ДобавлятьПериодВСодержание, ЛОЖЬ) КАК ДобавлятьПериодВСодержание,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.ВключатьВСчет, ВТОборотыОказано.ВключатьВСчет) КАК ВключатьВСчет,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.Количество, 0) КАК КоличествоПоДоговору,
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.Сумма, 0) КАК СуммаПоДоговору,
	...
	|ИЗ
	|	ВТДоговорыОбслуживанияАбонентскаяЧасть КАК ВТДоговорыОбслуживанияАбонентскаяЧасть
	|		ПОЛНОЕ СОЕДИНЕНИЕ ВТОборотыОказано КАК ВТОборотыОказано
	|		ПО ВТДоговорыОбслуживанияАбонентскаяЧасть.Договор = ВТОборотыОказано.Договор
	|			И ВТДоговорыОбслуживанияАбонентскаяЧасть.ОбъектДоговораОбслуживания = ВТОборотыОказано.ОбъектДоговораОбслуживания
	|			И ВТДоговорыОбслуживанияАбонентскаяЧасть.Характеристика = ВТОборотыОказано.Характеристика
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОборотыВыставлено КАК ВТОборотыВыставлено
	|		ПО (ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.Договор, ВТОборотыОказано.Договор) = ВТОборотыВыставлено.Договор)
	|			И (ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.ОбъектДоговораОбслуживания, ВТОборотыОказано.ОбъектДоговораОбслуживания) = ВТОборотыВыставлено.ОбъектДоговораОбслуживания)
	|			И (ЕСТЬNULL(ВТДоговорыОбслуживанияАбонентскаяЧасть.Характеристика, ВТОборотыОказано.Характеристика) = ВТОборотыВыставлено.Характеристика)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТВсеОбороты.Договор КАК Договор,
	|	ВТВсеОбороты.ОбъектДоговораОбслуживания КАК ОбъектДоговораОбслуживания,
	|	ВТВсеОбороты.Характеристика КАК Характеристика,
	|	ВТВсеОбороты.ПредставлениеВСчете КАК ПредставлениеВСчете,
	|	ВТУсловияПоПозициямТарифныхПланов.ДобавлятьПериодВСодержание КАК ДобавлятьПериодВСодержание,
	|	ВТВсеОбороты.ВключатьВСчет КАК ВключатьВСчет,
	|	ВЫБОР
	|		КОГДА ТИПЗНАЧЕНИЯ(ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	...
	|	ВТВсеОбороты.СуммаПоДоговору КАК СуммаПоДоговору,
	|	ВЫБОР
	|		КОГДА ТИПЗНАЧЕНИЯ(ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|				ИЛИ ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения ЕСТЬ NULL
	...
	|	ВТВсеОбороты.СуммаОказаноСЦеной КАК СуммаОказаноСЦеной,
	|	ВЫБОР
	|		КОГДА ТИПЗНАЧЕНИЯ(ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|				ИЛИ ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения ЕСТЬ NULL
	...
	|	ВТВсеОбороты.ЦенаПоВидуЦен КАК ЦенаПоВидуЦен,
	|	ВТВсеОбороты.СуммаОказаноБезЦены КАК СуммаОказаноБезЦены,
	|	ВЫБОР
	|		КОГДА ТИПЗНАЧЕНИЯ(ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения) = ТИП(Справочник.КлассификаторЕдиницИзмерения)
	|				ИЛИ ВТУсловияПоПозициямТарифныхПланов.ЕдиницаИзмерения ЕСТЬ NULL
	...
	|	ВТВсеОбороты.СуммаВыставлено КАК СуммаВыставлено,
	|	ВЫБОР
	...
	|	ВТВсеОборотыВЕдиницахИзмерения.ЦенаПоВидуЦен КАК ЦенаПоВидуЦен,
	...
	|ВЫБРАТЬ
	|	ВТВсеОборотыВЕдиницахИзмерения.Договор КАК Договор,
	|	ВТВсеОборотыВЕдиницахИзмерения.ОбъектДоговораОбслуживания КАК ОбъектДоговораОбслуживания,
	|	ВТВсеОборотыВЕдиницахИзмерения.Характеристика КАК Характеристика,
	|	ВТВсеОборотыВЕдиницахИзмерения.ПредставлениеВСчете КАК ПредставлениеВСчете,
	|	ВТВсеОборотыВЕдиницахИзмерения.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	ВТВсеОборотыВЕдиницахИзмерения.КоличествоПоДоговору КАК КоличествоПоДоговору,
	|	ВТВсеОборотыВЕдиницахИзмерения.СуммаПоДоговору КАК СуммаПоДоговору,
	|	ВТВсеОборотыВЕдиницахИзмерения.КоличествоОказаноСЦеной КАК КоличествоОказаноСЦеной,
	|	ВТВсеОборотыВЕдиницахИзмерения.СуммаОказаноСЦеной КАК СуммаОказаноСЦеной,
	|	ВТВсеОборотыВЕдиницахИзмерения.КоличествоОказаноБезЦены КАК КоличествоОказаноБезЦены,
	|	ВТВсеОборотыВЕдиницахИзмерения.СуммаОказаноБезЦены КАК СуммаОказаноБезЦены,
	|	ВТВсеОборотыВЕдиницахИзмерения.ЦенаПоВидуЦен КАК ЦенаПоВидуЦен,
	|	ВТВсеОборотыВЕдиницахИзмерения.КоличествоВыставлено КАК КоличествоВыставлено,
	|	ВТВсеОборотыВЕдиницахИзмерения.СуммаВыставлено КАК СуммаВыставлено,
	|	ВТВсеОборотыВЕдиницахИзмерения.ДобавлятьПериодВСодержание КАК ДобавлятьПериодВСодержание
	|ИЗ
	|	ВТВсеОборотыВЕдиницахИзмерения КАК ВТВсеОборотыВЕдиницахИзмерения
	|ГДЕ
	|	ВТВсеОборотыВЕдиницахИзмерения.ВключатьВСчет";
		...
		Если ТипЗнч(НоваяСтрока.ОбъектДоговораОбслуживания) = Тип("СправочникСсылка.Номенклатура") Тогда
			Если КоличествоОказаноБезЦены <> 0 И СуммаОказаноБезЦены = 0
				...
				ТекстОшибки = СтрШаблон(
					...
					НоваяСТрока.Договор,
					Справочники.Номенклатура.Представление(НоваяСтрока.ОбъектДоговораОбслуживания, НоваяСтрока.Характеристика),
	...
	Для Итератор = 0 По Параметры.СписокДоговорыОбслуживания.Количество() - 1 Цикл
		...
		Попытка
			Если СтрДоговор.ФормироватьСчет Тогда
				...
				СчетНаОплату = СоздатьСчетНаОплату(СчетНаОплатуДата, СтрДоговор.Договор, СтрДоговор.Контрагент,
					РасшифровкаБиллинга);
			...
			Если Параметры.ФормированиеАктов
				...
				АктВыполненныхРабот = СоздатьАктВыполненныхРаботПоСчету(
					АктВыполненныхРаботДата, СчетНаОплату.Ссылка, Параметры.ФормированиеАктовПроводить);
		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				...
				ПредставлениеДоговора, ТекстОшибки);
...
Функция СоздатьСчетНаОплату(Дата, Договор, Контрагент, ОборотыПоДоговору)
	...
	ДанныеЗаполнения.Вставить("Организация", ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "Организация"));
	
	СчетНаОплату = Документы.СчетНаОплату.СоздатьДокумент();
	СчетНаОплату.Дата = Дата;
	СчетНаОплату.Заполнить(ДанныеЗаполнения);
	Если НЕ СчетНаОплату.ПроверитьЗаполнение() Тогда
		Сообщения = ПолучитьСообщенияПользователю(Истина);
	КонецЕсли;
	СчетНаОплату.ОснованиеПечати = Строка(Договор);
	СчетНаОплату.ОснованиеПечатиСсылка = Договор;
	...
	Для каждого Стр Из ОборотыПоДоговору Цикл
		...
		Если Стр.ДобавлятьПериодВСодержание Тогда
			Периодичность = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Стр.Договор, "ДоговорОбслуживанияПериодичность");
			
			ПараметрыНоменклатуры = Новый Структура;
			Если ЗначениеЗаполнено(НоваяСтрока.ПредставлениеВСчете) Тогда
				ПараметрыНоменклатуры.Вставить("ПредставлениеНоменклатуры", НоваяСтрока.ПредставлениеВСчете);
			Иначе
				ПараметрыНоменклатуры.Вставить("ПредставлениеНоменклатуры", НоваяСтрока.ОбъектДоговораОбслуживания);
				ПараметрыНоменклатуры.Вставить("ПредставлениеХарактеристики", НоваяСтрока.Характеристика);
			КонецЕсли;
			
			ПредставлениеНоменклатуры = ПечатьДокументовУНФ.ПредставлениеНоменклатуры(ПараметрыНоменклатуры);
			НоваяСтрока.Содержание = НоменклатураВДокументахКлиентСервер.СодержаниеНоменклатурыСПериодом(
				ПредставлениеНоменклатуры, СчетНаОплату.Дата, Периодичность);
		КонецЕсли;
...
Функция СоздатьСчетФактуруПоАктуВыполненныхРабот(Дата, АктВыполненныхРабот)
	...
	Если АктВыполненныхРабот.РаботыИУслуги.Итог("СуммаНДС") > 0 Тогда
...
Функция СоздатьЭлектронноеПисьмо(ШаблонСообщения, Договор, ДокументыКОтправке)
	...
	Исключение
		ТекстСообщения = СтрШаблон(
			НСтр("ru='Не удалось автоматически отправить электронное письмо по причине: %1'"),
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Пакетное формирование счетов и электронных писем'"),
			УровеньЖурналаРегистрации.Ошибка, Метаданные.Документы.Событие,, ТекстСообщения);
		ВызватьИсключение;
	КонецПопытки;
...
Функция ПолучитьДанныеЗаполненияЭлектронногоПисьма(ШаблонСообщения, Договор, ДокументыКОтправке)
	...
	СформированноеСообщение = ШаблоныСообщений.СформироватьСообщение(
		ШаблонСообщения, Договор, Новый УникальныйИдентификатор, ДополнительныеПараметрыПисьма);
