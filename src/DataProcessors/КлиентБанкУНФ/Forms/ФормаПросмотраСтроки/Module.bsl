...
Процедура УстановитьПредставление()
	...
	Элементы.РаскрашенныйТекст.Видимость = Элементы.ФорматированныйВид.Пометка;
	Элементы.НеРаскрашенныйТекст.Видимость = НЕ Элементы.ФорматированныйВид.Пометка;
...
Функция ПолучитьСтруктуруДляПередачиВФормуПросмотра(ТекущаяСтрока)
	...
	ЗаголовокОкнаПросмотра = СтрШаблон(НСтр("ru = '%1 №%2 от %3'"), ТекущаяСтрока.Операция, ТекущаяСтрока.НомерДок,
		Формат(ТекущаяСтрока.ДатаДок, "ДЛФ=D;"));
...
Функция ПосмотретьВОтдельномОкнеПлатежноеПоручениеНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_ПлатежноеПоручение");
...
Функция ПосмотретьВОтдельномОкнеПлатежноеПоручениеНеПрямыеРасчетыНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_ПлатежноеПоручениеНеПрямыеРасчеты");
...
Функция ПосмотретьВОтдельномОкнеБанковскийОрдерНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_БанковскийОрдер");
...
Функция ПосмотретьВОтдельномОкнеПлатежноеТребованиеНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_ПлатежноеТребование");
...
Функция ПосмотретьВОтдельномОкнеИнкассовоеПоручениеНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_ИнкассовоеПоручение");
...
Функция ПосмотретьВОтдельномОкнеАккредитивНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_Аккредитив");
...
Функция ПосмотретьВОтдельномОкнеОперациюНаСервере(ТекущаяСтрока)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.КлиентБанкУНФ.ПФ_MXL_НеНайденаОперация");
