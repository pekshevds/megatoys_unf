...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("Касса", Касса)
		Или Не ЗначениеЗаполнено(Параметры.Касса) Тогда
	...
	ДанныеНастроекПоКассе = РегистрыСведений.НастройкиКассОФД.ДанныеНастроекПоКассе(
		Параметры.Касса);
