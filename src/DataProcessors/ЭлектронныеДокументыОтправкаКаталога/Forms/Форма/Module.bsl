...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("НациональныйКаталог")
		И Параметры.НациональныйКаталог = Истина Тогда
		ВыгружатьЕдиницыИзмеренияНоменклатуры = Ложь;
		Элементы.ВыгружатьЕдиницыИзмеренияНоменклатуры.Видимость = Ложь;
	КонецЕсли;
