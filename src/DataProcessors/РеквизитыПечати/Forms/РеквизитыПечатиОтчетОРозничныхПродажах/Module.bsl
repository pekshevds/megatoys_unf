...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, Подразделение, СтруктурнаяЕдиница,
		|ПодписьРуководителя, ПодписьЗаведующегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира");
...
Процедура ВосстановитьПодписиПоУмолчанию(Команда)
	...
	ПредыдущиеЗначения = Новый Структура(" ПодписьРуководителя, ПодписьЗаведующегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира");
...
Процедура ПолучитьПодписиПоУмолчаниюНаСервере()
	...
	ДокументОбъект = ДанныеФормыВЗначение(КонтекстПечати, Тип("ДокументОбъект.ОтчетОРозничныхПродажах"));
