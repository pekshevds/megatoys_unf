...
Процедура ПолучитьПодписиПоУмолчаниюНаСервере()
	...
	ДокументОбъект = ДанныеФормыВЗначение(КонтекстПечати, Тип("ДокументОбъект.Взаимозачет"));
...
Процедура ЗаписатьНастройкуПользователя(НазваниеНастройки, ЗначениеНастройки)
	...
	ПоказатьОповещениеПользователя(СтрокаЗаголовка, , СтрокаТекста, БиблиотекаКартинок.СохранитьЗначениеНастройки,
