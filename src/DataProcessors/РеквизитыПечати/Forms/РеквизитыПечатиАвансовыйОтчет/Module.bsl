...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИменаРеквизитов = "Организация, ПодписьРуководителя, ПодписьГлавногоБухгалтера, ПодписьБухгалтера";
...
&НаКлиенте
Процедура ПодписьБухгалтераПриИзменении(Элемент)
...
&НаКлиенте
Процедура СохранитьПодписьБухгалтера(Команда)
	
	ЗаписатьНастройкуПользователя("ПодписьБухгалтера", КонтекстПечати.ПодписьБухгалтера);
...
Процедура УстановитьКартинкиКнопок()
	...
	Элементы.СохранитьПодписьБухгалтера.Картинка = КартинкаСохранения;
