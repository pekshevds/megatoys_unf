...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, ПлановаяОценка, ВидОперации,
		|ПодписьРуководителя, ПодписьКонтролера, СтруктурнаяЕдиницаЗапасов, СтруктурнаяЕдиницаПродукции,
		|СтруктурнаяЕдиница, ПодписьКладовщикаПолучил, ПодписьКладовщикаОтправил");
...
&НаКлиенте
Процедура СохранитьПодписьКонтролераНажатие(Команда)
	
	ЗаписатьНастройкуПользователя("ПодписьМОЛ", КонтекстПечати.ПодписьКонтролера);
...
Процедура ЗаполнитьПодсказкиПодписей() 
	...
	Если КонтекстПечати.ПодписьКонтролера = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(КонтекстПечати.СтруктурнаяЕдиница,
			"ПодписьМОЛ") Тогда
		Элементы.ПодписьКонтролера.Подсказка = НСтр("ru='Подпись из реквизитов структурной единицы'");
	Иначе
		Элементы.ПодписьКонтролера.Подсказка = НСтр("ru='Подпись из настроек пользователя'");
	КонецЕсли;
