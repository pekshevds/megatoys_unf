...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастройкаПодключенияКопирование = Неопределено;
	ДанныеКопирования = Неопределено;
	ДополнительныеПараметры = Неопределено;
	ОснованиеПлатежа = Неопределено;
	
	Параметры.Свойство("НастройкаПодключения", НастройкаПодключенияКопирование);
	...
	ЕстьНастройкиПодключения
		= Справочники.НастройкиПодключенияКСистемеБыстрыхПлатежей.ЕстьНастройкиПодключения();
			...
			Если ЗначениеЗаполнено(ИдентификаторУчастника) Тогда
				...
				Если НастройкиУчастника <> Неопределено Тогда
					ДобавитьНастройкиПодключения(
						...
						НастройкиУчастника.ИдентификаторУчастника);
				Иначе
