...
Функция ТекстЗапросаПечатьКонвертовКонтрагенты()
	...
	|			И Организации.ФизическоеЛицо = ФИОФизическихЛиц.ФизическоеЛицо"
...
Функция ТекстЗапросаПечатьКонвертовДокументы(МетаданныеОбъектаПечати, ПараметрыПечати)
	...
	|			И СпрОрганизации.ФизическоеЛицо = ФИОФизическихЛиц.ФизическоеЛицо
	...
	|			И ТаблицыОбъектаПечати.Организация.ФизическоеЛицо = ФИОФизическихЛиц.ФизическоеЛицо
