...
Процедура СоздатьЭлементыПоказатели()
	...
	Для каждого Стр Из ДобавленныеПоказатели Цикл
		...
		Если ПустаяСтрока(Стр.ИмяГруппы) Тогда
			...
			ДобавитьКоманду(Стр.ИмяГруппы, "_Колонка", ЭлементЗаголовок, "КонтекстИзменитьКолонкуПоказатель", НСтр("ru = 'Изменить колонку'"), БиблиотекаКартинок.ПереключениеМеждуРежимами);
			...
			ДобавитьКоманду(Стр.ИмяГруппы, "_Колонка", ЭлементДекорацияИконка, "КонтекстИзменитьКолонкуПоказатель", НСтр("ru = 'Изменить колонку'"), БиблиотекаКартинок.ПереключениеМеждуРежимами);
