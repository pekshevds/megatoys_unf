...
Процедура ПолучитьНоменклатуруСЦеной(АдресВременногоХранилища)
	...
	СтруктураТаблицДанных = Обработки.ФормированиеЦенНоменклатуры.РазобратьДеревоНоменклатуры(ДеревоНоменклатуры, ПоказыватьНедействительныеХарактеристики);
...
Процедура ВидыЦенНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("Обработка.ФормированиеЦенНоменклатуры.Форма.ВидыЦен", ПараметрыОткрытия, ЭтаФорма, , , , ОбработкаОповещения);
