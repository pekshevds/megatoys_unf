...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаИспользоватьСтаруюОбработкуПечатиЦенников.Видимость = ПолучитьФункциональнуюОпцию("ПечатьЭтикетокИЦенников") И НЕ ПолучитьФункциональнуюОпцию("ИспользоватьСтаруюОбработкуПечатиЦенников");
	
	УстановитьДоступность();
	НастроитьВидимостьКомандНастройкиРМК();
...
&НаКлиенте
Процедура ПлатежныеОперации(Команда)
...
&НаСервере
Процедура НастроитьВидимостьКомандНастройкиРМК()
	
	ИспользоватьНовоеРМК = ПолучитьФункциональнуюОпцию("ИспользоватьНовоеРМК");
	Элементы.ОбщаяКомандаНастройкиРМК.Видимость = ИспользоватьНовоеРМК;
	Элементы.СправочникНастройкиРМКНастройкиРМК.Видимость = Не ИспользоватьНовоеРМК;
	
КонецПроцедуры

&НаКлиенте
Процедура ШаблоныЭтикеток(Команда)
