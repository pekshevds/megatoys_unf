...
Процедура ОбновитьПриложениеДоУНФ(Команда)
	...
	Если РазделениеВключено Тогда
		ОткрытьФорму("Обработка.НастройкаПрограммы.Форма.ОбновлениеРозницыДоУНФВСервисе");
	Иначе
...
&НаКлиенте
Процедура ОткрытьНастройкиРегламентированногоУчетаЗарплатыИКадров(Команда)
	
	ОткрытьФорму("Обработка.НастройкиБЗКБ.Форма.Форма",,
		ЭтотОбъект,
		УникальныйИдентификатор,,,,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ПриУстановкеДоступностиНастроек(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "ФункциональнаяОпцияИспользоватьОтчетность"
		Или РеквизитПутьКДанным = "" Тогда
		Элементы.ОткрытьНастройкиРегламентированногоУчетаЗарплатыИКадров.Доступность = ФункциональнаяОпцияИспользоватьОтчетность;
	КонецЕсли;
