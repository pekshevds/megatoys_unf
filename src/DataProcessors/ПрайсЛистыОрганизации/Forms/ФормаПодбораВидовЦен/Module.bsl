...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ВыводитьЦенуСЕдиницейИзмерения", Объект.ВыводитьЦенуСЕдиницейИзмерения);
...
Процедура ОК(Команда)
	...
	Результат.Вставить("ВыводитьЦенуСЕдиницейИзмерения", Объект.ВыводитьЦенуСЕдиницейИзмерения);
