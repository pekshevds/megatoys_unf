	...
	Если ЗначениеЗаполнено(Параметры.АдресВХранилище) Тогда
		...
		Если СтруктураДанных.Свойство("ОрганизацииЕГАИС") Тогда
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
				СписокОрганизацийЕГАИС.КомпоновщикНастроек.Настройки.Отбор, "Ссылка", СтруктураДанных.ОрганизацииЕГАИС,
...
Процедура УстановитьСоответствие(Команда)
	...
	ОткрытьФорму("Обработка.УдалениеСопоставлениеОрганизацийЕГАИС.Форма.ФормаСопоставленияКонтрагентов", ПараметрыФормы, ЭтотОбъект,,,, ОповещениеПриЗавершении);
...
Процедура СоздатьКонтрагентов_Подтверждение(РезультатВопроса, ВыделенныеСтроки) Экспорт
	...
	ОткрытьФорму("Обработка.УдалениеСопоставлениеОрганизацийЕГАИС.Форма.ФормаСозданияКонтрагентов", ПараметрыФормы, ЭтотОбъект,,,, ОповещениеПриЗавершении);
...
Функция СоздатьКонтрагентовНаСервере(АдресПараметровСозданияКонтрагентов)
	...
	Для каждого ОрганизацияЕГАИС Из ПараметрыСозданияКонтрагентов.МассивЭлементов Цикл
		...
		ОрганизацияЕГАИСОбъект.Сопоставлено = Истина;
...
Процедура УстановитьВидимостьСвойствОтбора()
	...
	Элементы.ГруппаВидыОтборовПоСвойствамЕГАИС.Видимость = ИспользоватьОтборПоСвойствам;
