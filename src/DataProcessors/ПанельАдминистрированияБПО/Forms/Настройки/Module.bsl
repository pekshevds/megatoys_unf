...
Процедура ИзменитьИспользованиеОчисткиОпераций(ИмяЗадания)
	...
	Если ИмяЗадания = "ОчисткаИсторииПлатежныхОпераций" Тогда
		Если МенеджерОборудованияВызовСервера.ИспользуетсяПлатежныеСистемы() Тогда
			...
			СрокХранения = МодульОборудованиеПлатежныеСистемыВызовСервера.СрокХраненияПлатежныхОперацийИзНабораКонстант(НаборКонстант);
		КонецЕсли;
	ИначеЕсли ИмяЗадания = "ОчисткаИсторииОперацийОчередиЧеков" Тогда
		Если МенеджерОборудованияВызовСервера.ИспользуетсяЧекопечатающиеУстройства() Тогда
			...
			СрокХранения = МодульОборудованиеЧекопечатающиеУстройстваВызовСервера.СрокХраненияОперацийОчередиЧековИзНабораКонстант(НаборКонстант);
		КонецЕсли;
	ИначеЕсли ИмяЗадания = "ОчисткаИсторииФискальныхОпераций" Тогда
		Если МенеджерОборудованияВызовСервера.ИспользуетсяЧекопечатающиеУстройства() Тогда
			МодульОборудованиеЧекопечатающиеУстройстваВызовСервера = ОбщегоНазначения.ОбщийМодуль("ОборудованиеЧекопечатающиеУстройстваВызовСервера");
			СрокХранения = МодульОборудованиеЧекопечатающиеУстройстваВызовСервера.СрокХраненияФискальныхОперацийИзНабораКонстант(НаборКонстант);
		КонецЕсли;
	КонецЕсли;
