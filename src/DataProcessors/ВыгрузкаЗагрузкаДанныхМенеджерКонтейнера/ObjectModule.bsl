...
Перем КоличествоОбрабатываемыхОбъектовПоОбъектамМетаданных;
...
Процедура ЗафиксироватьНачалоОбработкиОбъектаМетаданных(ОбъектМетаданных) Экспорт
	...
	ЗаписьСостояния.ОбработаноОбъектовДоТекущегоОбъектаМетаданных = ЗаписьСостояния.ОбработаноОбъектов;
	ЗаписьСостояния.ИмяОбрабатываемогоОбъектаМетаданных = ОбъектМетаданных.ПолноеИмя();
...
Функция ОбъектовКОбработкеПоОбъектуМетаданных(ОбъектМетаданных) Экспорт
	...
	СтрокаКоличестваОбрабатываемыхОбъектов = КоличествоОбрабатываемыхОбъектовПоОбъектамМетаданных.Найти(
...
Процедура ОбъектыОбработаны(Количество) Экспорт
	...
	ОбновитьСостояние(ДатаОбработкиОбъекта);
					
	Если ДатаОбработкиОбъекта < МинимальнаяДатаСледующейЗаписиСостояния Тогда
		Возврат;
	КонецЕсли;
				
	ЗаписатьСостояние(ДатаОбработкиОбъекта);
...
Функция ДобавитьФайл(Знач ВидФайла, Знач Расширение = "xml", Знач ТипДанных = Неопределено)
	...
	Если ВидФайла = ВыгрузкаЗагрузкаДанныхСлужебный.Digest()
		...
		ИЛИ ВидФайла = ВыгрузкаЗагрузкаДанныхСлужебный.DumpWarnings() Тогда
...
Процедура ИнициализироватьСостояние()
	...
	Если ДляЗагрузки Тогда
		КоличествоОбрабатываемыхОбъектовПоОбъектамМетаданных = ВыгрузкаЗагрузкаДанныхСлужебный.КоличествоЗагружаемыхОбъектовПоОбъектамМетаданных(
			Состав,
			Параметры.ЗагружаемыеТипы,
			ДляТехническойПоддержки);
	Иначе
		КоличествоОбрабатываемыхОбъектовПоОбъектамМетаданных = ВыгрузкаЗагрузкаДанныхСлужебный.КоличествоВыгружаемыхОбъектовПоОбъектамМетаданных(
	...
	Если Не Параметры.Свойство("ВсегоОбъектов", ВсегоОбъектов) Тогда
		ВсегоОбъектов = КоличествоОбрабатываемыхОбъектовПоОбъектамМетаданных.Итог("ЧислоОбъектов");
	КонецЕсли;	
