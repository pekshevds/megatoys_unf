...
Функция СсылкиНаСтатьи() Экспорт
	...
	Ссылки.Добавить(Перечисления.ДоступныеАТС.МТТ,                "https://www.mtt.ru/services/telephony/virtualnaya-ats/");
	Ссылки.Добавить(Перечисления.ДоступныеАТС.Билайн,             "https://beeline.ru/business/telephony/cloud-ats/");
...
Функция ЭтоПлатформаItoolabs(АТС) Экспорт
	...
	АТСНаПлатформеItoolabs.Добавить(Перечисления.ДоступныеАТС.МТТ);
