...
Функция СписокВидовНалоговыхОбязательств(НалогСсылка, Знач Период = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(НалогСсылка) Тогда
		...
		ВидГосударственногоОргана = ПлатежиВБюджетКлиентСервер.ВидГосударственногоОргана(СвойстваНалога.КодБК);
	Иначе
	...
	// Налог, Взносы
	НеактуальныеНалоги = ПлатежиВБюджетКлиентСервер.НеактуальныеНалоги();
...
Функция ПредставлениеНалоговогоОбязательства(НалогСсылка, ВидНалоговогоОбязательства) Экспорт
	...
	ВидГосударственногоОргана = Справочники.ВидыНалогов.ВидГосударственногоОргана(НалогСсылка);
	Если ЗначениеЗаполнено(ВидГосударственногоОргана) Тогда
		...
		Если ВидГосударственногоОргана = Перечисления.ВидыГосударственныхОрганов.НалоговыйОрган Тогда
			Если ПлатежиВБюджетКлиентСервер.ЭтоВзносыНаПенсионноеСтрахование(ВидНалога) Тогда
				...
				КонецЕсли;
			ИначеЕсли ПлатежиВБюджетКлиентСервер.ЭтоВзносыНаСоциальноеСтрахование(ВидНалога) Тогда
