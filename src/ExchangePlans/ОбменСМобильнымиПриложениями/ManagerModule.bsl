...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	Настройки.РежимВыборочнойРегистрации = ОбменДаннымиРегистрацияСервер.РежимВыборочнойРегистрацииСогласноПравиламXML() ;
...
// Позволяет дополнить или ограничить полученный набор поддерживаемых объектов.
// 
// Параметры:
//  ТаблицаОбъекты     - ТаблицаЗначений 
//  Режим 			- Строка 
//  УзелОбмена     		- ПланОбменаСсылка  
//
Процедура ПриОпределенииПоддерживаемыхОбъектовФормата(ТаблицаОбъекты, Режим, УзелОбмена) Экспорт    
	
	Если ЗначениеЗаполнено(УзелОбмена) И УзелОбмена.МобильноеПриложение.ВариантНастройки = "ПроверкаЦенников" Тогда     
		ВызватьИсключение НСтр("ru = 'Указанная настройка обмена создана для режима ""Проверка ценников"".'");
	КонецЕсли;
