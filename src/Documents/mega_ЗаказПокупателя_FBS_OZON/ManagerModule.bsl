...
Функция СформироватьПечатнуюФормуСтикеры(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	
	УстановитьПривилегированныйРежим(Истина);
	
	
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_mega_ЗаказПокупателя_FBS_OZON_Стикер";
...
Функция СформироватьПечатнуюФормуСтикерыЛокализация(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
