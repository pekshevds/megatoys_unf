...
Процедура ОткрытьПомощникПодготовкиУведомления()
	...
	Если ИмяОтчета = "РегламентированноеУведомлениеЗачетНалога" Тогда
		...
		Если ВыбранаАктуальнаяФормаУведомления(ПолеРедакцияФормы) Тогда
			...
			ОткрытьФорму("Документ.ЗаявлениеОЗачетеВСчетПредстоящейОбязанности.Форма.ФормаДокумента", ПараметрыУведомления);
