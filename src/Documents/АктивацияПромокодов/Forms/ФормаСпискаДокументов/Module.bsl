...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	УсловиеПредоставленияСкидки = Настройки.Получить("УсловиеПредоставленияСкидки");
	
	УстановитьОтборДинамическогоСписка("УсловиеПредоставленияСкидки");
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.АктивацияПромокодов.Форма.ФормаДокумента.Открытие");
...
Процедура ПриОткрытии(Отказ)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.АктивацияПромокодов.Форма.ФормаСпискаДокументов.Открытие");
	
КонецПроцедуры

&НаКлиенте
Процедура ОтборУсловиеПредоставленияСкидкиОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	Если Не ЗначениеЗаполнено(ВыбранноеЗначение) Тогда
		Возврат;
	КонецЕсли;
	
	УстановитьМеткуИОтборСписка("УсловиеПредоставленияСкидки", Элемент.Родитель.Имя, ВыбранноеЗначение);
...
&НаКлиенте
Процедура ОтборУсловиеПредоставленияСкидкиПриИзменении(Элемент)
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.АктивацияПромокодов.Форма.ФормаДокумента.СозданиеНового");
