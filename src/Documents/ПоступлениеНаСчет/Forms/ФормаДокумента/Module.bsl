...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() И НЕ ЗначениеЗаполнено(Параметры.ЗначениеКопирования) Тогда
		...
		Если Не ЗначениеЗаполнено(Параметры.ДокументОснование) Тогда
			...
			Иначе
				Объект.УчитыватьВНУ = ДенежныеСредстваФормы.УчитыватьВНУПоОснованию(Параметры.Основание, Объект.Дата);
			КонецЕсли;
		КонецЕсли;
...
Процедура ЗаполнитьПоОснованиюЗавершениеНаСервере()
	...
	Если НалогообложениеЗаполненоВОбработкеЗаполнения Тогда
		Объект.УчитыватьВНУ = ДенежныеСредстваФормы.УчитыватьВНУПоОснованию(Объект.ДокументОснование, Объект.Дата);
		Элементы.Патент.Доступность = Не Объект.УчитыватьВНУ;
	КонецЕсли;
