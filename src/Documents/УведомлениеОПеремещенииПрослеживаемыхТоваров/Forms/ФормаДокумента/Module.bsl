...
Процедура ПодготовитьФормуНаСервере()
	...
	ФормыДокумента   = Новый ФиксированноеСоответствие(
		Документы.УведомлениеОПеремещенииПрослеживаемыхТоваров.ПолучитьСоответствиеВидовУведомленийФормам());
...
Функция ПолучитьСписокВидовУведомлений()
	...
	СписокВидовУведомлений.Добавить(ВидыУведомлений.Уведомление, 
		НСтр("ru = 'Уведомление о перемещении прослеживаемых товаров'"));
	СписокВидовУведомлений.Добавить(ВидыУведомлений.КорректировочноеУведомление, 
		НСтр("ru = 'Корректировочное уведомление о перемещении прослеживаемых товаров'"));
...
Процедура ОткрытьДокументВида(ВыбранныйВидУведомления)
	...
	ОткрытьФорму("Документ.УведомлениеОПеремещенииПрослеживаемыхТоваров.Форма." 
		+ ФормыДокумента[ВыбранныйВидУведомления], СтруктураПараметров, ВладелецФормы);
