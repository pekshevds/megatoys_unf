...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПрицепТип.СписокВыбора.ЗагрузитьЗначения(ОбменСГИСЭПДКлиентСервер.ПолучитьМассивТиповПрицепов());
...
Процедура ХранимыеДанныеТитулПеревозчикаСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулПеревозчикаПрицепОснованиеВладенияРеквизитыСторон.ТекущиеДанные);
...
Процедура ХранимыеДанныеТитулПеревозчикаСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулПеревозчикаПрицепОснованиеВладенияРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулПеревозчикаПрицепОснованиеВладенияРеквизитыСторон.ТекущиеДанные);
