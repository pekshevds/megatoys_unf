...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТитулПеревозчикаТранспортноеСредствоТип.СписокВыбора.ЗагрузитьЗначения(ОбменСГИСЭПДКлиентСервер.ПолучитьМассивТиповТС());
...
Процедура ХранимыеДанныеТитулПеревозчикаСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулПеревозчикаОснованияВладенияТС.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулПеревозчикаОснованияВладенияТС.ТекущиеДанные);
