...
Функция СостояниеОтправки()
	...
	// Вариант обхода:
	//ЗаполнитьЗначенияСвойств(РегистрацияСведений, РегистрСведенийМенеджерЗаписи, , "ОшибкиЛогическогоКонтроля");
...
Процедура ОбновитьЭлементыГруппыВидДоговора(Видимость, Представление)
	Видимость = ЭтоОбычныйБольничный Или ЭтоБольничныйПоБиР;
	Если Не Видимость Тогда
		Возврат;
	КонецЕсли;
	Массив = Новый Массив;
...
Процедура ОбновитьЭлементыГруппыПараметрыНазначения(Группа, Представление, Заполнена, Развернута, Видимость)
	...
	Элементы.СоставСтрахователейЗаДваГодаГруппа.Видимость = ЭтоОбычныйБольничный Или ЭтоБольничныйПоБиР;
	Если Элементы.СоставСтрахователейЗаДваГодаГруппа.Видимость
