...
Процедура ВывестиПечатнуюФормуСЗВ_К(ТабличныйДокумент, ВыборкаПоШапкеДокумента, ВыборкаПоЗаписямСтажа, ТаблицаИтоговогоСтажа, НомерДокумента)
	...
	Макет = ?(ДатаПостановленияАДВ2022 <= ВыборкаПоШапкеДокумента.Дата,
		УправлениеПечатью.МакетПечатнойФормы("Документ.ПачкаДокументовСЗВ_К.ПФ_MXL_ФормаСЗВ_К_2022"),
		УправлениеПечатью.МакетПечатнойФормы("Документ.ПачкаДокументовСЗВ_К.ПФ_MXL_ФормаСЗВ_К_2019"));
