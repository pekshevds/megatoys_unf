...
Процедура СформироватьТаблицаЗапасыПродажа(ДокументСсылкаПередачаТоваровМеждуОрганизациями, СтруктураДополнительныеСвойства)
	...
	|	ПередачаТоваровМеждуОрганизациями.Проект";
	...
	ТаблицаЗапасыОстатки.Индексы.Добавить("Организация,СтруктурнаяЕдиница,СчетУчета,Номенклатура,Характеристика,Партия,ЗаказПокупателя,Проект");
