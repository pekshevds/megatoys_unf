...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОперацииПнДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Пн %1'"), Формат(Объект.ДатаС, "ДФ=dd.MM"));
	Элементы.ОперацииВтДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Вт %1'"), Формат(Объект.ДатаС + 86400, "ДФ=dd.MM"));
	Элементы.ОперацииСрДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Ср %1'"), Формат(Объект.ДатаС + 86400*2, "ДФ=dd.MM"));
	Элементы.ОперацииЧтДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Чт %1'"), Формат(Объект.ДатаС + 86400*3, "ДФ=dd.MM"));
	Элементы.ОперацииПтДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Пт %1'"), Формат(Объект.ДатаС + 86400*4, "ДФ=dd.MM"));
	Элементы.ОперацииСбДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Сб %1'"), Формат(Объект.ДатаС + 86400*5, "ДФ=dd.MM"));
	Элементы.ОперацииВсДлительность.Заголовок = СтрШаблон(НСтр("ru = 'Вс %1'"), Формат(Объект.ДатаС + 86400*6, "ДФ=dd.MM"));
...
Процедура ОперацииКомментарийНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("ОбщаяФорма.РедактированиеТекста", ПараметрыФормы, , , , ,
		Новый ОписаниеОповещения("ОперацииКомментарийНачалоВыбораЗавершение", ЭтотОбъект,
...
Процедура ОперацииЗаказчикОбработкаВыбораВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ВыбранноеЗначение = Тип("СправочникСсылка.ДоговорыКонтрагентов") Тогда
		...
		ОткрытьФорму("Справочник.ДоговорыКонтрагентов.Форма.ФормаВыбораСКонтрагентом", , , , , ,
			Новый ОписаниеОповещения("ОперацииЗаказчикОбработкаВыбораВыбораЗавершение", ЭтотОбъект));
...
Процедура ЗаполнитьПоПлану(Команда)
	...
	Если Объект.Операции.Количество() > 0 Тогда
		ПоказатьВопрос(Новый ОписаниеОповещения("ЗаполнитьПоПлануЗавершение", ЭтотОбъект), НСтр(
