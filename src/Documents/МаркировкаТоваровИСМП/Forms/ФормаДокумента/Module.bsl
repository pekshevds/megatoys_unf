...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.ТоварыСертификация.АвтоОтметкаНезаполненного = ЭтоТрансграничнаяТорговля И ЭтоПиво;
	...
	Элементы.ДатаПроизводства.Видимость = (ЭтоКонтрактноеПроизводство
		...
		Или (ЭтоОперацияНанесения И (ЭтоБАД Или ЭтоПиво Или ЭтоБАПиво Или ЭтоКреслаКоляски)))
		Или (ПрисутствуетОперацияНанесения И ЭтоПиво);
	
	Элементы.ДатаПроизводства.АвтоОтметкаНезаполненного =
		(ЭтоБАД Или ЭтоПиво Или ЭтоБАПиво Или ЭтоКреслаКоляски) И (ЭтоОперацияНанесения Или ЗначениеЗаполнено(ОперацияНанесения))
		Или Не (ЭтоШины Или ЭтоБАД Или ЭтоПиво Или ЭтоБАПиво Или ЭтоКреслаКоляски) И (ЭтоПроизводствоРФ Или ЭтоКонтрактноеПроизводство)
	...
	Элементы.Подразделение.Видимость = Форма.ПодразделенияИспользуются И ЭтоПиво
	...
	Элементы.Сертификация.Видимость                 = ОтчетПроизводственнойЛинии И ЭтоВводВОборот И Не ЭтоИмпортСФТС И Не ЭтоМех;
	...
	Если ЗначениеЗаполнено(ОперацияНанесения) Тогда
		...
		Если Не (ЭтоШины Или ЭтоБАД Или ЭтоПиво Или ЭтоБАПиво) Тогда
...
Процедура ЗаполнитьДоступныеОперации()
	...
	ВидыПродукцииОперацииИмпортСФТС.Вставить(Перечисления.ВидыПродукцииИС.Пиво, Истина);
