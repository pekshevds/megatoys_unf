...
Процедура ЗагрузитьИзВнешнегоФайла(Команда)
	...
	ДоступнаИерархия = Объект.ОтчетПроизводственнойЛинии
		И (ИнтеграцияИСКлиентСервер.ЭтоПродукцияМОТП(Объект.ВидПродукции) 
			Или ИнтеграцияИСКлиентСервер.ВидПродукцииИспользуетПередачуОтчетаОбОтбраковкеЧерезСУЗ(Объект.ВидПродукции));
...
Процедура ЗаполнитьДоступныеПричининыВыбытия(Форма)
	...
	ИначеЕсли ИнтеграцияИСКлиентСервер.ВидПродукцииИспользуетПередачуОтчетаОбОтбраковкеЧерезСУЗ(Объект.ВидПродукции)
		Или ЭтоАльтернативныйТабак Или ЭтоНСП Тогда
...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.ДанныеОтчетаПроизводственнойЛинииЗначениеШтрихкодаУпаковки.Видимость = ОтображатьИсходныеЗначенияКодов 
		И (ЭтоПродукцияМОТП Или ПередачаОтчетаЧерезСУЗ);
	...
	Если ПередачаОтчетаЧерезСУЗ Или ЭтоПродукцияМОТП Тогда
