...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПоляГруппыНоменклатуры(ТаблицаПолейЗагрузки,
		ОписанияТиповПолей, ОписаниеТиповКолонка);
	...
	ВидимостьРезервирование = (НастройкиЗагрузкиДанных.Свойство("ИспользуетсяРезервирование")
		И НастройкиЗагрузкиДанных.Свойство("ЕстьРозничноеПеремещение")) И (НастройкиЗагрузкиДанных.ИспользуетсяРезервирование
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "ЗаказПокупателя", НСтр(
		"ru = 'Заказ покупателя'"), ОписанияТиповПолей.ОписаниеТиповСтрока50, ОписаниеТиповКолонка, , , , ,
		ВидимостьРезервирование);
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "СтавкаНДС", НСтр(
		"ru = 'Ставка НДС (для новой номенклатуры)'"), ОписанияТиповПолей.ОписаниеТиповСтрока50, ОписаниеТиповКолонка);
...
Процедура СопоставитьЗагружаемыеДанныеИзВнешнегоИсточника(ПараметрыСопоставления, АдресРезультата) Экспорт
	...
	Для каждого СтрокаТаблицыФормы Из ТаблицаСопоставленияДанных Цикл
		...
		Если ИспользуетсяРезервирование И НЕ ЕстьРозничноеПеремещение Тогда
			ДопустимыеТипыЗаказа = Документы.ЗаказНаПеремещение.ДопустимыеТипыЗаказа(НастройкиЗагрузкиДанных.ВидОперации);
...
Функция СформироватьЗаказНаПеремещение(ОписаниеПечатнойФормы, МассивОбъектов, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		//+mega
		// Комментарий
		ОбластьКомментарий = Макет.ПолучитьОбласть("mega_Комментарий");
		ОбластьКомментарий.Параметры.Комментарий = 
			ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Шапка.Ссылка, "Комментарий");
