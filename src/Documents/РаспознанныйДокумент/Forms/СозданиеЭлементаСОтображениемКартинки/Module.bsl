...
Процедура Подключаемый_ПриИзменении(Элемент)
	...
	Подключаемый_ПриИзмененииНаСервере(Элемент.Имя);

КонецПроцедуры

&НаСервере
Процедура Подключаемый_ПриИзмененииНаСервере(ИмяЭлемента)
...
Процедура ПроверитьИННКПП(ПроверитьИНН, ПроверитьКПП)
	...
	РаспознаваниеДокументовПереопределяемый.ОтобразитьРезультатПроверкиКонтрагентовВФорме(ЭтотОбъект);
...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.СтавкаНДС.ОграничениеТипа = Метаданные.ОпределяемыеТипы.СтавкаНДС.Тип;
	Элементы.ВидНоменклатуры.ОграничениеТипа = Метаданные.ОпределяемыеТипы.ВидНоменклатурыРаботаСНоменклатурой.Тип;
