...
Процедура УдалитьУстаревшиеДокументы() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не Выборка.ПометкаУдаления Тогда
			Объект.ДополнительныеСвойства.Вставить("ПометкаУдаленияУстановленаРегЗаданием", Истина);
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'РаспознаваниеДокументов.УдалениеУстаревшихДокументов'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Функция ПравилаОбработкиСущностей()
	...
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.КонтрагентБРД.Тип;
	...
	Правило.ПодклассСущности = "Свойства";
	Правило.Путь = "Компания.Наименование";
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.ОрганизацияБРД.Тип;
	...
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.БанковскиеСчетаБРД.Тип;
	...
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.ДоговорыБРД.Тип;
	...
	Правило.Путь = "";
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.СкладБРД.Тип;
	...
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.НоменклатураБРД.Тип;
	...
	Правило.ОписаниеТипа = Метаданные.ОпределяемыеТипы.СтавкаНДСБРД.Тип;
