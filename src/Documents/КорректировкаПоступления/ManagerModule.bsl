...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаКорректировкаПоступления, СтруктураДополнительныеСвойства) Экспорт
	...
	|			ИНАЧЕ (ИзмененияЗапасов.Всего - ИзмененияЗапасов.СуммаНДС) * ИзмененияЗапасов.Ссылка.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * ИзмененияЗапасов.Ссылка.Кратность)
	...
	|			ИНАЧЕ ИзмененияЗапасов.СуммаРасходовБезНДС * ИзмененияЗапасов.Ссылка.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс * ИзмененияЗапасов.Ссылка.Кратность)
	|		КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаРасходовБезНДС,
	|	ВЫРАЗИТЬ(ВЫБОР
	|			КОГДА ИзмененияЗапасов.Ссылка.ВалютаДокумента = &ВалютаНациональная
	|				ТОГДА ИзмененияЗапасов.СуммаРасходовБезНДС * КурсыРегВалюты.Курс * ИзмененияЗапасов.Ссылка.Кратность / (ИзмененияЗапасов.Ссылка.Курс * КурсыРегВалюты.Кратность)
	...
	|			ИНАЧЕ ВЫБОР
	|					КОГДА  ИзмененияРасходов.Ссылка.ВалютаДокумента = &ВалютаНациональная
	|						ТОГДА ИзмененияРасходов.СуммаНДС * КурсыРегВалюты.Курс *  ИзмененияРасходов.Ссылка.Кратность / ( ИзмененияРасходов.Ссылка.Курс * КурсыРегВалюты.Кратность)
...
Функция ДанныеПолученныхДокументовРегУчет(МассивОбъектов, ИспользоватьФаксимиле, ПечатнаяФормаТолькоВРублях = Истина, Ошибки = Неопределено) Экспорт
	...
	|	КорректировкаПоступленияЗапасы.ПрослеживаемыйТовар КАК ПрослеживаемыйТовар,
	|	КорректировкаПоступленияЗапасы.КодТНВЭДЕдиницаИзмеренияКод КАК КодТНВЭДЕдиницаИзмеренияКод,
	|	КорректировкаПоступленияЗапасы.КодТНВЭДЕдиницаИзмеренияНаименование КАК КодТНВЭДЕдиницаИзмеренияНаименование
	|ИЗ
