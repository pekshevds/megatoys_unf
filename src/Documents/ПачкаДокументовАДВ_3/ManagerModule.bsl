...
Функция СформироватьВыходнойФайл2022(ВыборкаПоШапкеДокумента, ВыборкаПоРаботникам)
	...
	Если ВыборкаПоРаботникам.Следующий() Тогда 
		...
		ФорматАДВ_3.УТ3__Телефоны.Значение.УТ3__Телефон = ВыборкаПоРаботникам.Телефоны;
...
Функция СформироватьПечатнуюФормуАДВ3(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Пока ВыборкаСотрудники.Следующий() Цикл
			...
			Если ИспользоватьФорму2022 Тогда
			...
			Если ИспользоватьФорму2022 И ВыборкаСотрудники.АдресРегистрации = ВыборкаСотрудники.АдресФактический Тогда
			...
			Если Не ИспользоватьФорму2022 Тогда 
