...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.Увольнение") Тогда
		ЗаполнитьПоУвольнениюРеглУчет(ДанныеЗаполнения);
	Иначе
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.УвольнениеУНФ.ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства);
...
// Параметры:
//		Увольнение - ссылка на документ Увольнение
//
Процедура ЗаполнитьПоУвольнениюРеглУчет(Увольнение)
	Организация = Увольнение.Организация;
	Дата = Увольнение.Дата;
	НоваяСтрока = Сотрудники.Добавить();
	НоваяСтрока.Сотрудник = Увольнение.Сотрудник;
	НоваяСтрока.Период = Увольнение.ДатаУвольнения;
	НоваяСтрока.ОснованиеУвольнения = Увольнение.ОснованиеУвольнения;
КонецПроцедуры
