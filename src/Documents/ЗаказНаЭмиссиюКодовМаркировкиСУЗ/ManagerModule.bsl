			...
			Для Каждого СтрокаТЧ Из СодержаниеЗаказа Цикл
				...
				Иначе
					...
					Если Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.Антисептики
						Или Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы Тогда
						СтрокаЗаказаКодовМаркировки.Вставить("templateId", ИнтерфейсСУЗСлужебный.ШаблонКодаМаркировки(СтрокаТЧ.Шаблон));
					Иначе
				...
				Если Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.Духи
					...
					Или Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво
					Или Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.СоковаяПродукция
					Или Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.БезалкогольноеПиво
					Или Шапка.ВидПродукции = Перечисления.ВидыПродукцииИС.КреслаКоляски Тогда
					СтрокаЗаказаКодовМаркировки.Вставить("cisType", ИнтерфейсСУЗСлужебный.ТипКодаМаркировки(СтрокаТЧ.Шаблон));
				КонецЕсли;
