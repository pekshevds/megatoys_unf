...
Процедура ЗаполнитьТитулПеревозчикаЗаменыОснованиеВладенияТСРеквизитыСторонНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулПеревозчикаЗаменыОснованияВладенияТранспортнымСредством.ТекущиеДанные);
...
Процедура ТитулПеревозчикаЗаменыОснованияВладенияТранспортнымСредствомВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЗаполнитьТитулПеревозчикаЗаменыОснованиеВладенияТСРеквизитыСторон" Тогда
		ОписаниеГруппыДанных = ОбменСГИСЭПДКлиентСервер.ОписаниеГруппыДанных("", ЭтотОбъект.ИмяФормы);
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Поле.Имя, Элемент.ТекущиеДанные, , ОписаниеГруппыДанных.ЕстьХранимыеДанные);
		СтандартнаяОбработка = Ложь;
	КонецЕсли;
